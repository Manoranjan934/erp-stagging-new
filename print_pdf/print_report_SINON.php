...
header( "refresh:10;url=/index.php?erp=79" );
...
if (isset($data_id) && ($data_id != '')) {
    ...
    $getSQId = $obj_si->getNonCommInvoiceById($data_id);
    ...
    $getSQAddress = $obj_si->getNonCommInvoiceAddressById($data_id);
    ...
    $getSCProducts = $obj_si->getNonCommInvoiceProductByPROId($data_id);
    ...
    while ($datass = mysqli_fetch_array($getSCProducts)) {
        ...
        $getSCProduct = $obj_si->getNonCommInvoiceProductByIdForPDF($datass['PK_SEP_ID']);
...
$html = "<html><head>
	...
	<thead>
		...
		<tr>
			...
			<th style='border:0;vertical-align: baseline;width: 40%;font-size:15px;float:left'></th>
...
<tbody>
		...
		<tr><td  colspan='3' style='border-top:0;border-bottom:0;border-left:0;border-right:0;line-height:0;padding-top:2px;padding-bottom:5px;padding-left:6px;text-align:center'>

		<p><img src='../assets/images/AVogo.png' style='width: 150px;height: auto;padding-bottom:10px;'/></p>
...
<p><b>Phone:</b> 04212477600</p>
	...
	<td style='border:0;padding-top:5px;padding-bottom:0px;font-size:18px;text-align:center'><h4> Invoice</h4></td>
...
$html .= "<table cellspacing='0' cellpadding='0' style='border-width:0px;border-style:solid;border-color:#000;margin-bottom:0;border-top:0;border-bottom:0;border-left:0;border-right:0;margin-bottom:5px'>
				...
				<td   style='font-size:17px;width:60%;vertical-align:baseline;line-height:0;padding-top:2px;padding-left:6px;border-width:1px;border-style:solid;border-color:#000;'>
							...
							<tr >	<td  style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p>Estimate No:</p></td><td style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p style='text-transform:uppercase;'><b>" . $datas['e_sono'] . "</b></p></td>

							</tr >

							<tr >

							<td  style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p>Invoice No:</p></td><td style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p style='text-transform:uppercase;'><b>" . $sq_no . "</b></p></td>
						...
						<td   style='font-size:17px;width:60%;vertical-align:baseline;line-height:0;padding-top:2px;padding-left:6px;border-width:1px;border-style:solid;border-color:#000;'><p>Customer Details :</p>
						...
						<td colspan='2' style='border-left:0;border-right:0;border:0;padding:0;padding-bottom:2px;font-size:17px'></td><td style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p style='text-transform:uppercase;'><b>" . $cus_name . " </b></p></td>
						...
						<td colspan='2' style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p></p></td><td style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p>" . $cus_address . " " . $cus_address_2 . " " . $cus_address_3 . " " . $stateName['state'] . "-" . $cus_fax . "</p></td>

						</tr>

						<tr>

						<td colspan='2' style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p></p></td><td style='border:0;padding:0;padding-bottom:2px;font-size:17px'><p><b>Mobile: </b>" . $cus_mob_no . "</p></td>
...
$html .= "	<thead>
					...
					<tr class='headdetails' style='height:100px'><th style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;'><b>Item Types</b></th><th style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;'><b>	Item</b></th><th style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;'><b>HSN Code</b></th><th style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;'><b>	Price Type</b></th><th style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;'><b>	Orientation</b></th><th style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;'><b>	Quantity</b></th><th style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;text-align:right'>	<b>Total</b>[<img src='../assets/images/RS.png' style='width: 13px;height: 8px;'  />]</th>
...
for ($i = 0; $i < count($scproduct); $i++) {
	...
	if($scproduct[$i]['fk_types_id']==4 || $scproduct[$i]['fk_types_id']==5)
    ...
    $html .= "	<tr>
							...
							<td  style='text-transform:uppercase;padding-right: 5px;padding-top: 5px;padding-bottom:5px'> 4911</td>

							<td  style='text-transform:uppercase;padding-right: 5px;padding-top: 5px;padding-bottom:5px'> " . $pricetypes . "</td>

							<td  style='text-transform:uppercase;padding-right: 5px;padding-top: 5px;padding-bottom:5px'> " . $orientation . "</td>

							<td  style='text-transform:uppercase;padding-right: 5px;padding-top: 5px;padding-bottom:5px'> " . $scproduct[$i]['sep_qty'] . "</td>

							<td  style='padding-right: 5px;padding-top: 5px;padding-bottom:5px;text-align:right'>" . number_format($scproduct[$i]['sep_total'], 2) . "</td>
...
<td style='border-right:0;border-bottom:0;border-left:0;'></td>
	...
	<td  style='padding-top:2px;padding-bottom:2px;text-align:right;padding-right: 4px'> CGST (" . $datas['gst_percent'] . "%) [<img src='../assets/images/RS.png' style='width: 13px;height: 8px;'  />]</td>

	<td style='padding-top:2px;padding-bottom:2px;text-align:right;padding-right: 4px'>" . number_format($datas['gst_total'], 2) . "</td>
...
<td  style='padding-top:2px;padding-bottom:2px;text-align:right;padding-right: 4px'> SGST (" . $datas['sgst_percent'] . "%) [<img src='../assets/images/RS.png' style='width: 13px;height: 8px;'  />]</td>

<td style='padding-top:2px;padding-bottom:2px;text-align:right;padding-right: 4px'>" . number_format($datas['sgst_total'], 2) . "</td>
...
<td style='border-right:0;border-bottom:0;border-left:0;'></td>
	...
	<td  style='padding-top:2px;padding-bottom:2px;text-align:right;padding-right: 4px'> IGST (" . $datas['gst_percent'] . "%) [<img src='../assets/images/RS.png' style='width: 13px;height: 8px;'  />]</td>
...
$html .= "<tr>
					...
					<td rowspan='13' colspan='3' style='text-transform:uppercase;padding-top:4px;padding-bottom:2px;'><img src='../assets/images/RS.png' style='width: 13px;height: 8px;'  />, In Words : " . $inword . " Only.</td>

					<td colspan='2' style='padding-top:2px;padding-bottom:2px;text-align:center;padding-right: 4px'><b>Grand Total</b>  [<img src='../assets/images/RS.png' style='width: 13px;height: 8px;'  />]</td>

					<td colspan='1' style='border-top:0;text-transform:uppercase;border-bottom:1px solid #000000;padding-top:2px;padding-bottom:2px;text-align:right;padding-right: 4px'><b>" . $datas['grand_total'] . "</b></td>
