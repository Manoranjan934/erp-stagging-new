...
$discount = $obj_nu->convertCurrencyToWords(sprintf("%01.2f", $datas['discount_final']));
...
for ($i = 0; $i < count($scproduct); $i++) {
	...
	if ($scproduct[$i]['itemtype'] == 1 || $scproduct[$i]['itemtype'] == 4) {
...
if ($datas['discount_final'] > 0) {
	...
	$discount_field = '';
	if ($datas['discount_field'] == 1) {
		$discount_field = 'Transport';
	} else if ($datas['discount_field'] == 2) {
		$discount_field = 'Courier';
	}
	...
	$html .= "<tr>
					...
					<td  style='padding-top:2px;padding-bottom:2px;text-align:right;padding-right: 4px'>" . $discount_field . " " . $discount_final . " [<img src='../assets/images/RS.png' style='width: 13px;height: 8px;'  />]</td>
...
$remarksSection = "<table style='display: table;'>
			...
			<tr><td style='border-right:0 !important;border-bottom:0 !important;padding-top:2px;padding-bottom:4px;font-size:12px'>Remarks: <b>" . $datas['remark'] . "</b><br>" . $advanceSection . "<br><b>Sheets:</b> " . $sheetTotal . "</td></tr></table></body></html>";
