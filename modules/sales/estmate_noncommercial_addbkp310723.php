...
if(czid == 2)
{
    ...
    $('.txt_price_type').each(function() {
        ...
        if(ptczid == 1 || ptczid == 2){
            ...
            $('.txt_price_type_'+ptczid).find('option[value="'+czidval+'"]').attr("selected", true);
...
function addrow() {
    ...
    $('table .itemclone').append('<tr><td><select class="form-control txt_types txt_types_' + zz +
        ...
        '"  ></select></td><td><select class="form-control txt_orientation txt_orientation_' +zz + '"  name="txt_orientation[]" id="txt_orientation_' + zz + '"   ><option value="">Select Orientation</option><option value="1">Length</option><option value="2">Breadth </option><option value="">NONE </option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
...
function addinnersheetrow() {
    ...
    $('table .itemclone .addinnercls').after('<tr><td><button type="button" name="removeitems" id="removeitems" class="btn btn-danger removeitems" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + zz +'"   name="txt_itemtypes[]" id="txt_itemtypes_' + zz +'"     data-czid="' + zz +'" data-classids="txt_itemtypes_' + zz +'" value="4" >Inner Sheet</td><td ><select  class="form-control txt_item  txt_item_' + zz +'" name="txt_item[]" id="txt_item_' + zz + '" data-czid="' + zz + '"   onchange="cal()"></select></td><td><input onkeyup="cal()"  class="form-control txt_product_qty numbersOnly  txt_product_qty_' + zz + '" min="0" max="999999" id="txt_product_qty_' + zz + '" name="txt_product_qty[]" placeholder="Quantity"  value="1"></td><td><select class="form-control txt_price_type txt_price_type_' +zz +' " data-czid="' + zz + '"  name="txt_price_type[]" id="txt_price_type_' + zz + '"  ></select></td><td><select class="form-control txt_orientation txt_orientation_' +zz + '"  name="txt_orientation[]" id="txt_orientation_' + zz + '"   ><option value="">NONE </option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +zz + '"  class="form-control pricefield txt_price txt_price_' + zz + ' numberss text-right" onkeyup="cal()" value="0" ><input type="hidden" class="txt_comm txt_comm_' + zz + '" name="txt_comm" id="txt_comm" value=""></td><td ><input type="text" name="txt_final_total[]" id="txt_final_total_' +  zz + '" class="form-control txt_final_total_' + zz +' numberss txt_final_total text-right"  value="0.00" readonly></td></tr>'
    );
...
function addspecialeffectrow() {
    ...
    $('table .itemclone .addsplcls').after('<tr><td><button type="button" name="removeitems" id="removeitems" class="btn btn-danger removeitems" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + zz +'"   name="txt_itemtypes[]" id="txt_itemtypes_' + zz +'"    data-czid="' + zz +'" data-classids="txt_itemtypes_' + zz +'" value="5">Special Effects</td><td ><select  class="form-control txt_item  txt_item_' + zz +'" name="txt_item[]" id="txt_item_' + zz + '" data-czid="' + zz + '"  onchange="cal()"></select></td><td><input  class="form-control txt_product_qty numbersOnly  txt_product_qty_' + zz + '" min="0" max="999999" id="txt_product_qty_' + zz + '" name="txt_product_qty[]" onkeyup="cal()"  placeholder="Quantity"  value="1"></td><td><select class="form-control txt_price_type txt_price_type_' +zz + ' " data-czid="' + zz + '"  name="txt_price_type[]" id="txt_price_type_' + zz + '" ></select></td><td><select class="form-control txt_orientation txt_orientation_' +zz + '"  name="txt_orientation[]" id="txt_orientation_' + zz + '"   ><option value="">NONE </option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +zz + '"  class="form-control pricefield txt_price txt_price_' + zz + ' numberss text-right" onkeyup="cal()" value="0" ><input type="hidden" class="txt_comm txt_comm_' + zz + '" name="txt_comm" id="txt_comm" value=""></td><td ><input type="text" name="txt_final_total[]" id="txt_final_total_' +  zz + '" class="form-control txt_final_total_' + zz +' numberss txt_final_total text-right"  value="0.00" readonly></td></tr>'
    );
            ...
            success: function(response) {
                if (response) {
                    swal({
                        ...
                        //window.location.href = "index.php?erp=66";  
                        window.location.href = "index.php?erp=69&id="+response+"";

                       // window.location.href = "print_pdf/print_report_SONON.php?soid="+response+"";
