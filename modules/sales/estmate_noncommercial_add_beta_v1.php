                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <form class="form-horizontal theme-form" id="form_estimate_noncomm_add" autocomplete="off"
                            ...
                            <div class="card-footer text-right">
                                ...
                                <input type="hidden" name="mode" value="addEstimateNonCommBetaV1" />
...
<script>
    ...
    //         $('.txt_price_type').each(function() {
    //             var ptczid = $(this).attr("data-czid");
    //             if (ptczid == 1 || ptczid == 2) {} else {
    //                 $('.txt_price_type_' + ptczid).find('option[value="' + czidval + '"]').attr("selected",
    //                     true);
    //                 $('.txt_price_type_' + ptczid).trigger('change');
    //             }

    //         });
    //         /*   $('.txt_price_type_3').find('option[value="'+czidval+'"]').attr("selected", true);
    //            $('.txt_price_type_4').find('option[value="'+ czidval+'"]').attr("selected", true);
    //            $('.txt_price_type_5').find('option[value="'+czidval+'"]').attr("selected", true);
    //            $('.txt_price_type_6').find('option[value="'+czidval+'"]').attr("selected", true);
    //            $('.txt_price_type_7').find('option[value="'+ czidval+'"]').attr("selected", true);
    //            $('.txt_price_type_8').find('option[value="'+ czidval+'"]').attr("selected", true);

    //            $('.txt_price_type_3').trigger('change');
    //            $('.txt_price_type_4').trigger('change');
    //            $('.txt_price_type_5').trigger('change');
    //            $('.txt_price_type_6').trigger('change');
    //            $('.txt_price_type_7').trigger('change');
    //            $('.txt_price_type_8').trigger('change');*/
    //     }
    //     getCostListing(czid);
    ...
    //     var itemSelect = $('.txt_item_' + czid);
    //     var costtype = $('.txt_price_type_' + czid).find("option:selected").val();
    //     var typesval = $('.txt_itemtypes_' + czid).val();
    //     var itemToChangeQuantity = ["#txt_item_5", "#txt_item_6", "#txt_item_7", "#txt_item_8"];
    //     var itemid = itemSelect.find("option:selected").val();

    //     if (itemToChangeQuantity.includes('#' + itemSelect.attr('id'))) {
    ...
    //     var costtype = $('.txt_price_type_' + czid).find("option:selected").val();
    //     var typesval = $('.txt_itemtypes_' + czid).val();
    //     var itemToChangeQuantity = ["5", "6", "7", "8"];
    //     var itemid = itemSelect.find("option:selected").val();

    //     if (itemToChangeQuantity.includes(typesval)) {
    //         if (itemSelect.val() === 'SELECT ONE') {
    ...
    //     if (itemSelect.val() === 'SELECT ONE') {
    //         $('.txt_product_qty_' + czid).val('0');
    //         $('.txt_price_' + czid).val('0').trigger('change'); // Set price to 0 and trigger change event
    //     } else {
    //         // Continue with AJAX request
    //         $.ajax({
    //             url: "modules/sales/ajax_functions_noncommercial.php",
    ...
    //                 if (typesval === '5' || typesval === '6' || typesval === '7' || typesval === '8') {
    //                     $('.txt_product_qty_' + czid).val('1');
    //                 }

    //                 // Trigger calculation after setting the price and quantity
    //                 cal();
    //             },
    //             error: function(response) {
    //                 console.log(response);
...
*/
    ...
    //                 if ((itemType === '2' || itemType === '5' || itemType === '6' || itemType === '7' || itemType === '8') &&
    ...
    //             required: true,
    //             min: function(element) {
    //                 return parseFloat($(element).val()) > 0 ? false : 1;
    //             },
    //         },
    //         txt_grand_total: {
    //             required: true
    ...
    // Add onchange event handler for txt_item_2 (assuming it corresponds to the second row)
                ...
                success: function(response) {
                    if (response) {
                        swal({
                            ...
                            window.location.href = "index.php?erp=140&id=" + response;
                        });
                    } else {
                        swal("Failed!", "Something went wrong, Try again!", "error");
                    }
