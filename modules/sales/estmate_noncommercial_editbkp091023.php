        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal theme-form" id="form_estimatenoncomm_edit" novalidate="novalidate">
                            <div class="card-body">
                                <div id="stepwizard">
                                            ...
                                            <div class="control-field">
                                                <div>
                                                    <select class="form-control txt_customer_name "
                                                        ...
                                                        <?php if(isset($_SESSION['user_id']) && ($_SESSION['user_id'] == 6)) { } else{ echo "readonly='' style='pointer-events: none;'"; } ?>>
                                                        <option value="">Select Customer</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <input type="text" class="form-control txt_pi_date hasDatepicker valid"
                                                    ...
                                                    aria-invalid="false" <?php echo "readonly='' style='pointer-events: none;'"; ?>>
                                                <span class="error" id="txt_pi_date_error"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <input type="text" class="form-control txt_delivery_date hasDatepicker valid"
                                                    ...
                                                    aria-invalid="false" <?php if(isset($_SESSION['user_id']) && ($_SESSION['user_id'] == 6)) { } else{ echo "readonly='' style='pointer-events: none;'"; } ?>>
...
*/
                    ...
                    $('table .itemclone').append('<tr class="'+innersplcls+'"><td>'+addinnerdata+'</td><td ><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + vz +'" name="txt_itemtypes[]" id="txt_itemtypes_' + vz +'"     data-czid="' + vz +'" data-classids="txt_itemtypes_' + vz +'"  value="' + response[1][j].itemtype +'">' + response[1][j].types_name +'</td><td ><select  class="form-control txt_item  txt_item_' + vz + '" name="txt_item[]" id="txt_item_' + vz + '" data-czid="' + vz +'"   ></select></td><td><input class="form-control txt_product_qty numbersOnly  txt_product_qty_' +vz + '" min="0" max="999999" id="txt_product_qty_' + vz +'"  name="txt_product_qty[]" placeholder="Quantity"  onkeyup="cal()" value=' +
                        ...
                        '"   >'+$hideorient +' </select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
...
function addspecialeffectrow() {
    ...
    $('table .itemclone tr.addsplcls:last').after('<tr><td><button type="button" name="removeitemsspecial" id="removeitemsspecial" class="btn btn-danger removeitemsspecial" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + zz +'"   name="txt_itemtypes[]" id="txt_itemtypes_' + zz +'"    data-czid="' + zz +'" data-classids="txt_itemtypes_' + zz +'" value="5">Special Effects</td><td ><select  class="form-control txt_item  txt_item_' + zz +'" name="txt_item[]" id="txt_item_' + zz + '" data-czid="' + zz + '"   onchange="cal()"></select></td><td><input onkeyup="cal()"  class="form-control txt_product_qty numbersOnly  txt_product_qty_' + zz + '" min="0" max="999999" id="txt_product_qty_' + zz + '" name="txt_product_qty[]" placeholder="Quantity"  value="1"></td><td><select class="form-control txt_price_type txt_price_type_' +zz + ' " data-czid="' + zz + '"  name="txt_price_type[]" id="txt_price_type_' + zz + '"  onchange="cal()"></select></td><td><select class="form-control txt_orientation txt_orientation_' +zz + '"  name="txt_orientation[]" id="txt_orientation_' + zz + '" title="Orientation"  ><option value="">NONE </option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +zz + '" onkeyup="cal()" class="form-control pricefield txt_price txt_price_' + zz + ' numberss text-right" value="0" ><input type="hidden" class="txt_comm txt_comm_' + zz + '" name="txt_comm" id="txt_comm" value=""></td><td ><input type="text" name="txt_final_total[]" id="txt_final_total_' +  zz + '" class="form-control txt_final_total_' + zz +' numberss txt_final_total text-right"  value="0.00" readonly></td></tr>'
    );
...
function getCostTypeListingEdit(pricetype, zz) {
    $('.txt_price_type_' + zz).html('<option value="0" selected >SELECT ONE</option>');
        ...
        $('.txt_price_type_' + zz).append('<option value="1">Price (or) 4 Color</option><option value="2">Price (or) 7 Color</option>');
