...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>View Non Estimate Commercial</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">View Non Estimate Commercial</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <a href="javascript:;" class="btn btn-default sendmailpop" data-toggle="modal"
                            data-target="#sendOrder-popup"><i class="fa fa-envelope" aria-hidden="true"></i> Send
                            Mail</a>
                        <a href="index.php?erp=34&typ=2&id=<?php echo $_GET['id']; ?>" class="btn btn-success"
                            target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i> Status</a>
                        <a href="index.php?erp=80&type=2&id=<?php echo $_GET['id']; ?>" class="btn btn-warning"
                            target="_blank"><i class="fa fa-rupee-sign" aria-hidden="true"></i> Advance</a>
                        <a href="print_pdf/print_report_SONON.php?soid=<?php echo $_GET['id']; ?>" class="btn btn-primary"
                            target="_blank"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
                        <a href="print_pdf/print_report_SOWNON.php?soid=<?php echo $_GET['id']; ?>" class="btn btn-primary"
                                            ...
                                            <div class="control-field">
                                                <div>
                                                    <select class="form-control txt_customer_name "
                                                        ...
                                                        title="Customer" readonly onchange="customerChange()">
                                                        <option value="">Select Customer</option>
                                                        <?php
...
?>
                                            ...
                                            <div class="control-field">
                                                <div>
                                                    <select class="form-control txt_type_of_payment "
                                                        ...
                                                        <option value="2">Later Pay</option>
                                    ...
                                    <div class="col-4 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="control-label">Mode / Franchise</label>
                                            <div class="control-field">
                                            <select class="form-control txt_franchise "
                                                        name="txt_franchise" id="txt_franchise"
                                                        title="Franchise" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <select class="form-control txt_intstate "  name="txt_intstate"
                                                    id="txt_intstate" readonly>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="colum_split">
                                        <div class="one-half-column">
                                        <span style="float: left;" class="col-md-8"><p id="advanceinfomsg" style=" text-align: center;color:#ff0000;font-size:14px">Advance amount is₹): <span class="advanceamt"></span> <br>  Balance receivable is(₹): <span class="pendingamt"></span> </p></span>       
                                        </div>
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field3" 
                                                                            class="form-control  pull-left discount_field3" readonly></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
...
<div class="modal fade" id="sendOrder-popup" tabindex="-1" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog mdp-contact">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="">Send PDF </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body comment-area">
                <form method="post" action="mail.php" method="post" id="Formmail_pop" class="text-left">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label text-dark mb-2 font-weight-bold">Order No <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="txt_orderno_pop" class="txt_orderno_pop" placeholder="Order No"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label text-dark mb-2 font-weight-bold">Frorm Mail <span
                                    class="text-danger">*</span></label>
                            <div class="form-group"><input type="email" name="txt_emailfrom_pop" class=""
                                    placeholder="Email" required=""></div>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label text-dark mb-2 font-weight-bold">To Mail<span
                                    class="text-danger">*</span></label>
                            <div class="form-group"><input type="email" name="txt_emailto_pop" class=""
                                    placeholder="Email" required=""></div>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label text-dark mb-2 font-weight-bold">Message </label>
                            <div class="form-group"><textarea name="txt_message_pop" placeholder="Message"></textarea>
                            </div>
                        </div>

                        <div class="col-md-12">
                            <a href="print_pdf/print_report_SONON.php?soid=<?php echo $_GET['id']; ?>"
                                class="btn btn-primary" target="_blank"><i class="fa fa-print" aria-hidden="true"></i>
                                View PDF</a>
                                <input type="hidden" name="soid" value="<?php echo $_GET['id']; ?>">
                                <input type="hidden" name="mode" value="sendPDFmailNonComm">
                            <button type="submit" name="subsubmit_pop" value="subsubmit_pop"
                                class="btn-default mt-2">Send message</button>
                        </div>
                    </div>
                </form>
            </div>
...
.mdp-contact .comment-area form .form-group select,
...
$('.sendmailpop').on('click', function() {
    var sono = $('#txt_sono').val();
    $('.txt_orderno_pop').val(sono);
});
...
$('#Formmail_pop').validate({
   ...
   /* errorPlacement: function(error, element) {
    ...
    submitHandler: function(form) {
        var formData = new FormData($('#Formmail_pop')[0]);
        $('.btn_save').prop("disabled", true);

        $.ajax({
            url: "modules/sales/ajax_common.php",
            data: formData,
            type: 'post',
            async: false,
            dataType: 'json',
        ...
        success: function(response) {
            if (soid == 0) {
              ...
              //  $('#txt_delivery_date').val(response[0].franchise);
                ...
                $('#discount_amt').val(parseFloat(response[0].cus_plan_tot_amount).toFixed(2));
             ...
             /*   $('#discount_final5').val(parseFloat(response[0].discount_final5).toFixed(2));
                ...
                var pendingamt =    parseFloat(response[0].grand_total) - (parseFloat(response[0].advance) +parseFloat(response[0].receipts) + parseFloat(response[0].bulkPay)) ;

                $('.advanceamt').append('<b>'+parseFloat(response[0].advance)+'</b>');
                $('.pendingamt').append('<b>'+pendingamt+'</b>');
                ...
                for (j = 0; j < response[1].length; j++) {
                     ...
                     var innersplattr ='';
                        ...
                        if(response[1][j].itemtype==4)
                        {
                            ...
                            if(imty == 1){
                               ...
                               addinnerdata=    '<button type="button" name="removeitemsinner" id="removeitemsinner" class="btn btn-danger removeitemsinner" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button>';
                               }
                        }
                        else if(response[1][j].itemtype==5)
                        {
                            ...
                            if(spty == 1){
                               ...
                               addinnerdata=    '<button type="button" name="removeitemsspecial" id="removeitemsspecial" class="btn btn-danger removeitemsspecial" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button>';
                               }
                        }
                      /*  var addinnerdata ='';
                    ...
                    $('table .itemclone').append('<tr class="'+innersplcls+'"><td ><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + vz +'" name="txt_itemtypes[]" id="txt_itemtypes_' + vz +'"     data-czid="' + vz +'" data-classids="txt_itemtypes_' + vz +'"  value="' + response[1][j].itemtype +'">' + response[1][j].types_name +'</td><td ><select  class="form-control txt_item  txt_item_' + vz + '" name="txt_item[]" id="txt_item_' + vz + '" data-czid="' + vz +'"   readonly></select></td><td><input class="form-control txt_product_qty numbersOnly  txt_product_qty_' +vz + '" min="0" max="999999" id="txt_product_qty_' + vz +'"  name="txt_product_qty[]" placeholder="Quantity"  onkeyup="cal()" value=' +
                        response[1][j].qty +
                        ...
                        '"   onchange="cal()" readonly></select></td><td><select class="form-control txt_orientation txt_orientation_' +
                        vz + '"  name="txt_orientation[]" id="txt_orientation_' + vz +
                        '"   readonly>'+$hideorient +' </select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
                        vz + '"  class="form-control pricefield txt_price txt_price_' +
                        vz + ' numberss text-right"  onkeyup="cal()" value=' + response[1][j].price +
                        ' readonly></td><td ><input type="text" name="txt_final_total[]" id="txt_final_total_' +
...
function getCostTypeListing(types) {
    ...
    $('.txt_price_type_' + types).html('<option selected disabled>SELECT </option>');
        ...
        $('.txt_price_type_' + types).append('<option value="1">Price (or) 4 Color</option><option value="2">Price (or) 7 Color</option><option value="">NONE</option>');
...
function getCostTypeListingEdit(pricetype, zz) {
        ...
        $('.txt_price_type_' + zz).append('<option value="1">Price (or) 4 Color</option><option value="2">Price (or) 7 Color</option><option value="">NONE</option>');
...
function getComercialorNonItemsTypeEdit(itemtypesid,itemid,  zz) {
     var typesid = 2;
...
function cal() {
    ...
    if(gsttype == 1)
    {
       var inclusiveGST = parseFloat(total_total_amount) - parseFloat(gst_amttot)
        ...
        var discount_percentage = totalamt * plan_discount;
            $('#discount_amt').val(discount_percentage.toFixed(2));
           
           var discount_total =  totalamt - discount_percentage;
