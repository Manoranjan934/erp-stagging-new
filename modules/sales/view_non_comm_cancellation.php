...
?>
                                    ...
                                    <div class="col-4 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="control-label"> Types of Payment  <span
                                                    class="color">*</span></label>
                                            <div class="control-field">
                                                <div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="colum_split">
                                        <div class="one-half-column">
                                        <span style="float: left;" class="col-md-8"><p id="advanceinfomsg" style=" text-align: center;color:#ff0000;font-size:14px">Advance amount is: <span class="advanceamt"></span> <br>  Pending amount is: <span class="pendingamt"></span> </p></span>       
                                        </div>
        ...
        success: function(response) {
            if (soid == 0) {
             ...
             /*   $('#discount_final5').val(parseFloat(response[0].discount_final5).toFixed(2));
                ...
                var pendingamt =    parseFloat(response[0].grand_total) - parseFloat(response[0].advance) ;
