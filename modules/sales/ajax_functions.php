...
if(isset($_POST['mode']) && $_POST['mode']=='addSalesOrder'){
   ...
   /* $previousYr = date("y", strtotime("-1 year")); //last year
	...
	$obj_saleorder->setcity($_POST['txt_customer_city']);
	$obj_saleorder->setpaymenttype($_POST['txt_payment_type']);
	$obj_saleorder->setremark($_POST['txt_remarks']);
	$obj_saleorder->setgsttype($_POST['txt_intstate']);
    ...
    $obj_saleorder->setdiscount_field1($_POST['discount_field1']);
    $obj_saleorder->setdiscount_final1($_POST['discount_final1']);
    $obj_saleorder->setdiscount_final_amt1($_POST['discount_final_amt1']);
    $obj_saleorder->setdiscount_type1($_POST['discount_type1']);
    $obj_saleorder->setcaltype1($_POST['txt_cal_type1']);

    $obj_saleorder->setdiscount_field2($_POST['discount_field2']);
    $obj_saleorder->setdiscount_final2($_POST['discount_final2']);
    $obj_saleorder->setdiscount_final_amt2($_POST['discount_final_amt2']);
    $obj_saleorder->setdiscount_type2($_POST['discount_type2']);
    $obj_saleorder->setcaltype2($_POST['txt_cal_type2']);

    $obj_saleorder->setdiscount_field3($_POST['discount_field3']);
    $obj_saleorder->setdiscount_final3($_POST['discount_final3']);
    $obj_saleorder->setdiscount_final_amt3($_POST['discount_final_amt3']);
    $obj_saleorder->setdiscount_type3($_POST['discount_type3']);
	$obj_saleorder->setcaltype3($_POST['txt_cal_type3']);


  //  $obj_saleorder->setdiscount_field4($_POST['discount_field4']);
    $obj_saleorder->setdiscount_final4($_POST['discount_final4']);
    $obj_saleorder->setdiscount_final_amt4($_POST['discount_final_amt4']);
   // $obj_saleorder->setdiscount_type4($_POST['discount_type4']);
	//$obj_saleorder->setcaltype4($_POST['txt_cal_type4']);


   // $obj_saleorder->setdiscount_field5($_POST['discount_field5']);
   // $obj_saleorder->setdiscount_final5($_POST['discount_final5']);
  //  $obj_saleorder->setdiscount_type5($_POST['discount_type5']);
  $obj_saleorder->setdiscount_final_amt5($_POST['discount_final_amt5']);

	 
 //   $obj_saleorder->setcaltype5($_POST['txt_cal_type5']);
...
//exit;
	for ($i=0; $i < count($_POST['txt_itemtypes']); $i++) { 
		...
		//$obj_saleorder->setproduct_id($_POST['txt_product_name'][$i]);
		$obj_saleorder->setcategory_id($_POST['txt_category'][$i]);
		$obj_saleorder->settypes($_POST['txt_types'][$i]);
		$obj_saleorder->setpricetype($_POST['txt_price_type'][$i]);
		$obj_saleorder->setorientation($_POST['txt_orientation'][$i]);
		$obj_saleorder->settypes_id($_POST['txt_itemtypes'][$i]);
		$obj_saleorder->setitem_id($_POST['txt_item'][$i]);
...
//	$obj_saleorder->setreference_number($_POST['txt_reference_number']);
    ...
    $obj_saleorder->setdiscount_final1($discount_final1);
    $obj_saleorder->setdiscount_final_amt1($discount_final_amt1);
    $obj_saleorder->setdiscount_type1($discount_type1);
    $obj_saleorder->setcaltype1($txt_cal_type1);

    $obj_saleorder->setdiscount_field2($discount_field2);
    $obj_saleorder->setdiscount_final2($discount_final2);
    $obj_saleorder->setdiscount_final_amt2($discount_final_amt2);
    $obj_saleorder->setdiscount_type2($discount_type2);
    $obj_saleorder->setcaltype2($txt_cal_type2);

    $obj_saleorder->setdiscount_field3($discount_field3);
    $obj_saleorder->setdiscount_final3($discount_final3);
    $obj_saleorder->setdiscount_final_amt3($discount_final_amt3);
    $obj_saleorder->setdiscount_type3($discount_type3);
	$obj_saleorder->setcaltype3($txt_cal_type3);


  //  $obj_saleorder->setdiscount_field4($_POST['discount_field4']);
  $obj_saleorder->setdiscount_final4($discount_final4);
  $obj_saleorder->setdiscount_final_amt4($discount_final_amt4);
 // $obj_saleorder->setdiscount_type4($_POST['discount_type4']);
  //$obj_saleorder->setcaltype4($_POST['txt_cal_type4']);
...
if(isset($_POST['mode']) && $_POST['mode']=='updateSalesOrder'){
	...
	if(isset($_POST['mode']) && $_POST['mode'] == 'getComercialorNonItemsType') {
			...
			$getComercialItemsType=$obj_saleorder->getComercialorNonItemsType();
			$getitem=array();
	...
	/*if(isset($_POST['mode']) && $_POST['mode'] == 'getNonComercialItemsType') {
		...
		$getNonComercialItemsType=$obj_saleorder->getNonComercialItemsType();
		$getitem=array();
	...
	if(isset($_POST['mode']) && $_POST['mode'] == 'getCostListing') {
		/*	var_dump($_POST);
			...
			/*if($_POST['typesval'] == 1)
			{
				...
				$costval =	$obj_saleorder->getCostProduct();
				$costvaldata = mysqli_fetch_array($costval);
				if($_POST['costtype']  == 1)
				{
	...
	if(isset($_POST['mode']) && $_POST['mode']=='getAllCities'){
		$getAllCities=$obj_saleorder->getAllCities();
