...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>View Job Order</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">View Job Order</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                            ...
                                            <tbody class="itemclone custom_table_width">
                                                <tr>
                                                    ...
                                                    <td><select class="form-control txt_itemtypes txt_itemtypes_1 "
                                                            ...
                                                            data-classids="txt_itemtypes_1" readonly></select></td>
             ...
             /*   $('#discount_final5').val(parseFloat(response[0].discount_final5).toFixed(2));
                ...
                for (j = 0; j < response[1].length; j++) {
                    ...
                    $('table .itemclone').append(
                        ...
                        '" title="Types"  readonly> <option value="" >Select Types</option><option value="1">Commercial</option><option value="2">Non Commercial</option></select></td><td><select class="form-control txt_itemtypes txt_itemtypes_' + vz + ' " name="txt_itemtypes[]" id="txt_itemtypes_' + vz +
