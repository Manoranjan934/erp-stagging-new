...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>View Estimate Commercial</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">View Estimate Commercial</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="text-right mb-2">
                        ...
                        <a href="index.php?erp=34&typ=1&id=<?php echo $_GET['id']; ?>" class="btn btn-success"
                            target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i> Status</a>
                        <a href="index.php?erp=80&type=1&id=<?php echo $_GET['id']; ?>" class="btn btn-warning"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <input type="text"
                                                    ...
                                                    placeholder="DD/MM/YYYY" aria-invalid="false" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <textarea class="form-control txt_remarks" name="txt_remarks"
                                                    style="height: 77px !important;" id="txt_remarks"
                                                    readonly></textarea>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                            ...
                                            <tbody class="itemclone custom_table_width">
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="txt_price[]" id="txt_price_1"
                                                            ...
                                                            title="Price" value="0"><input type="hidden"
                                    ...
                                    <div class="colum_split">
                                        <div class="one-half-column">
                                        <span style="float: left;" class="col-md-8"><p id="advanceinfomsg" style=" text-align: center;color:#ff0000;font-size:14px">Advance amount is₹): <span class="advanceamt"></span> <br>  Balance Receivable is(₹): <span class="pendingamt"></span> </p></span>                                        </div>
                                                    ...
                                                    <tr class="apRow">
                                                            <td class="text-right">
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="padding-right: 15px;">Customer Selected Plan </label>      
                                                                        <label id="cusplanname" name="cusplanname"></label> <label id="cusplandiscount" name="cusplandiscount"></label>                                                            
                                                                </span>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field3"
                                                                            class="form-control  pull-left discount_field3"
                                                                            readonly></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
            ...
            <div class="modal-body comment-area">
                <form method="post" action="mail.php" method="post" id="Formmail_pop" class="text-left">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="print_pdf/print_report_SO.php?soid=<?php echo $_GET['id']; ?>"
                            ...
                            <input type="hidden" name="mode" value="sendPDFmailComm">
            ...
            if (soid == 0) {
                ...
                for (j = 0; j < response[1].length; j++) {
                    ...
                    $('table .itemclone').append(
                        ...
                        '"  name="txt_product_qty[]" placeholder="Quantity" title="Quantity"  value=' +
                        response[1][j].qty +
                        ' readonly></td><td><select class="form-control txt_price_type txt_price_type_' +
                        vz +
                        ...
                        '" title="Orientation"  readonly><option value="">Select Orientation</option><option value="0">NONE</option><option value="1">Length</option><option value="2">Breadth</option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
