                                            ...
                                            <tbody class="itemclone custom_table_width">
                                                <tr>
                                                    <td><select class="form-control txt_item  txt_item_1"
                                                            name="txt_item[]" id="txt_item_1" data-czid="1"></select></td>
    ...
    function cal() {
        ...
        if (txtstate == 33) {
            ...
            if (parseFloat(cgst_amt) > 0) {
                ...
                console.log("cgst_amttot:" + cgst_amttot);
            } else {
                $("#cgst_total").val("");
            }
            /*
...
*/
            ...
            if (parseFloat(sgst_amt) > 0) {
                ...
                console.log("sgst_amttot:" + sgst_amttot);
            } else {
                $("#sgst_total").val("");
            }
            ...
            console.log(csgst_total_final_amount);
