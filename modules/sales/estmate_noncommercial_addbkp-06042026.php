                                            ...
                                            <tbody class="itemclone custom_table_width">
                                                ...
                                                while ($types_rows = mysqli_fetch_array($gettypes)) {
                                                    ...
                                                    if ($types_rows['pk_types_id'] == 4) {
                                                        $innersplattr = 'onclick="addinnersheetrow()"';
                                                        $innersplcls = 'addinnercls';
                                                    } else if ($types_rows['pk_types_id'] == 5) {
                                                        $innersplattr = 'onclick="addspecialeffectrow()"';
                                                    ...
                                                    echo '<tr class="' . $innersplcls . '"> <td>' . $addinnerdata . '
                                                        </td><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' . $i . ' "   name="txt_itemtypes[]" id="txt_itemtypes_' . $i . '"
                                                        data-czid="' . $i . '" data-classids="txt_itemtypes_' . $i . '" value=' . $types_rows['pk_types_id'] . '>' . $types_rows['types_name'] . '</td>
                                                <td><select class="form-control txt_item  txt_item_' . $i . '"
                                                        name="txt_item[]" id="txt_item_' . $i . '" data-czid="' . $i . '"  
                                                        ></select></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <input type="text"
                                                                    name="txt_advance"
                                                                    id="txt_advance"
                                                                    class="form-control pull-right w-21 text-right numberss"
...
<script>
    ...
    $('table').on("change", ".txt_types", function(e) {
        ...
        if (types == 1) {
            $('.txt_itemtypes_' + czid).html(
                '<option selected >Select One</option><option value="0">Product</option>');
        } else if (types == 2) {
    ...
    function getCostListing(czid) {
        ...
        if (typesval === '2' || typesval === '5' || typesval === '6' || typesval === '7' || typesval === '8') {
            ...
            if (itemSelect.val() === "") {
                $('.txt_product_qty_' + czid).val('0');
            } else if ($('.txt_product_qty_' + czid).val() == '0') {
                $('.txt_product_qty_' + czid).val('1');
            }
        }
    ...
    function getComercialorNonItemsTypeCategory(type, parent_id) {
        //alert('test');
        var typesid = 2;
        var itemtypeId = type;
        //   var pkid = $('.txt_itemtypes_' + type).find("option:selected").attr('data-pkid');
    ...
    function addinnersheetrow() {
        ...
        $('table .itemclone .addinnercls').after(
            '<tr><td><button type="button" name="removeitems" id="removeitems" class="btn btn-danger removeitems" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' +
            zz + '"   name="txt_itemtypes[]" id="txt_itemtypes_' + zz + '"     data-czid="' + zz +
            '" data-classids="txt_itemtypes_' + zz +
    ...
    function addspecialeffectrow() {
        ...
        $('table .itemclone .addsplcls').after(
            '<tr><td><button type="button" name="removeitems" id="removeitems" class="btn btn-danger removeitems" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' +
            zz + '"   name="txt_itemtypes[]" id="txt_itemtypes_' + zz + '"    data-czid="' + zz +
            '" data-classids="txt_itemtypes_' + zz +
    ...
    function calAdvance(e) {
        ...
        var advance = parseFloat($('#txt_advance').val()) || 0;
...
*/
    ...
    $('#form_estimate_noncomm_add').validate({
        rules: {
            ...
            //         var priceField = $('#txt_price_' + czid);
            //         var finalPrice = $('#txt_final_total_' + czid);
            //         var grandTotal = $('#txt_item_total' + czid);
