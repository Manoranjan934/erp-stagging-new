...
$query = mysqli_query(
    ...
    "SELECT sono, grand_total FROM erp_estimate_noncomm WHERE PK_ES_ID='$soid'"
);
            ...
            var options = {
                ...
                handler: function(response) {
                    fetch("verify_payment.php", {
                        ...
                        //         window.location.href = "http://staging.rishidhkannan.com/index.php?erp=71&typ=2&mnu=19";
                        //     } else {
                        //         window.location.href = "http://staging.rishidhkannan.com/index.php?erp=71&typ=2&mnu=19";
                        //     }
                        // });
