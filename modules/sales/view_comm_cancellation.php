                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="colum_split">
                                        <div class="one-half-column">
                                        <span style="float: left;" class="col-md-8"><p id="advanceinfomsg" style=" text-align: center;color:#ff0000;font-size:14px">Advance amount is: <span class="advanceamt"></span> <br>  Pending amount is: <span class="pendingamt"></span> </p></span>                                        </div>
            ...
            if (soid == 0) {
                ...
                for (j = 0; j < response[1].length; j++) {
                    ...
                    $('table .itemclone').append(
                        ...
                        '" title="Orientation"  readonly><option value="">Select Orientation</option><option value="1">Length</option><option value="2">Breadth</option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
