        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal theme-form" id="form_bag_Edit" novalidate="novalidate">
                <div class="card-body">
                  <div id="stepwizard">
                       ...
                       <!--   <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control txt_bag_id" name="txt_bag_id" id="txt_bag_id" placeholder="Auto" title=" Code" readonly="" value="<?php echo $rows['pk_bag_id']; ?>">
                              <span class="error" id="txt_bag_id_error"></span>
                            </div>
                          </div>-->
                          <input type="hidden" class="form-control txt_bag_id" name="txt_bag_id" id="txt_bag_id"  value="<?php echo $rows['pk_bag_id']; ?>">
                      ...
                      <input type="hidden" name="mode" id="mode" value="EditBag">
