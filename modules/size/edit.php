        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal theme-form" id="form_size_Edit" novalidate="novalidate">
                <div class="card-body">
                  <div id="stepwizard">
                        <div class="one-half-column">
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control txt_size_id" name="txt_size_id" id="txt_size_id" placeholder="Auto" title=" Code" readonly="" value="<?php echo $rows['pk_size_id']; ?>">
                              <span class="error" id="txt_size_id_error"></span>
                            </div>
                          </div>
                          <div class="form-group">
                      ...
                      <input type="hidden" name="mode" id="mode" value="EditSize">
