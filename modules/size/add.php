...
<div class="content-wrapper" style="min-height: 1342.88px;">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal theme-form" id="form_size_add" novalidate="novalidate">
                <div class="card-body">
                  <div id="stepwizard">
                      ...
                      <input type="hidden" name="mode" id="mode" value="AddSize">
  ...
  $(".master_size .nav-link").addClass("active");
</script>