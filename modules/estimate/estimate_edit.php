                                ...
                                <div class="tab-content">
                                    <div class="text-right">
                                        <span class="btn btn-sm btn-primary btn-mint mar-btm" id="additems"
                                            onclick="addrow();" style="margin-top:-40px;"><i
                                                class="fa fa-plus mr-2"></i>Add row
                                        </span>
                                    </div>
                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            <td class="d-flex justify-content-end">
                                                                ...
                                                                <input type="radio" name="txt_intstate"
                                                                    class="form-control txt_intstate pullrightchk pull-right w-21 text-right numberss ml-lg-5"
...
$('#form_sale_estimate_edit').on('keyup keypress', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (eid == 0) {
                ...
                getJobOrderEdit(response[0].fk_so_id, vz, response[0].fk_customer_id, response[0].types);
...
function getJobOrderEdit(so_id, zz, cusId, types) {
    $.ajax({
        url: "modules/estimate/ajax_functions.php",
        data: {
            'id': cusId,
...
function addrow() {
    ...
    $('table .itemclone').append(
        ...
        ' numberss txt_final_total text-right" title="Grand Total" readonly></td><td><button type="button" name="removeitems" id="removeitems" class="removeitems btn btn-danger" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td></tr>'
        );
    //getTypesListing(zz);
