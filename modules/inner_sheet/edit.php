...
$obj_is->setid($_GET['id']); 
$getcate = $obj_is->geteditInnersheet();
...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Inner Sheet</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Edit Inner Sheet</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal theme-form" id="form_innersheet_Edit" novalidate="novalidate">
                <div class="card-body">
                  <div id="stepwizard">
                        <div class="one-half-column">
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control txt_is_id" name="txt_is_id" id="txt_is_id" placeholder="Auto" title="Code" readonly="" value="<?php echo $rows['pk_is_id']; ?>">
                              <span class="error" id="txt_is_id_error"></span>
                            </div>
                          </div>
                          <div class="form-group">
                      ...
                      <input type="hidden" name="mode" id="mode" value="EditInnersheet">
