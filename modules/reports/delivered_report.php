...
<button type="submit" name="submit" class="btn btn-info">Search</button>
                    ...
                    <form class="row" autocomplete="off" method="post" id="rmcyte_employee">
                        ...
                        <div class="col-lg-3 form-group">
                            ...
                            <select class="form-control txt_franchise_name" name="txt_franchise_name" id="txt_franchise_name">
                                <option value="">All</option>
                                <?php
                                ...
                                while ($franch = mysqli_fetch_array($getfranchise)) { ?>
                                    <option value="<?php echo $franch['pk_cat_id']; ?>">
                                        <?php echo $franch['cat_name']; ?>
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
    ...
    var dataRecords = $('#estimateTable').DataTable({
        "footerCallback": function(row, data, start, end, display) {
            ...
            if (roleId == 999 || roleId == 1) {
                ...
                // Total over all pages for column 9 (advance)
                totalColumn9 = api
                    .column(8)
                    .data()
                    .reduce(function(a, b) {
                ...
                // Total over this page for column 9 (advance)
                ...
                // Update footer for column 9 (advance)
                $(api.column(8).footer()).html('₹' + pageTotalColumn9.toFixed(2));
                ...
                // Total over this page for column 10
                ...
                // Update footer for column 10 using the calculateTotalAmount() function
                $(api.column(9).footer()).html('₹' + pageTotalColumn10.toFixed(2));
                $(api.column(10).footer()).html(calculateTotalAmount());
            }
        },
