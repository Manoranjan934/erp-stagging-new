...
$query = "SELECT cus_name  from erp_customer_master as cus where cus.pk_cus_id='".$_GET['cusid']."'";
	...
	$heading='Outstanding Reports for '.ucfirst(strtolower($customerName));						

							



function getTable($customerID,$tableName,$payTable,$bulTable,$fromda,$toda,$fransid)
...
if($fransid){
  $frans = "AND est.franchise='".$fransid."'";
	  ...
	  $query = "SELECT est.PK_ES_ID, (est.grand_total) as totalAmt,est.sono, est.sale_date,est.order_status,est.delivery_date FROM ".$tableName." as est where est.customer_id='".$customerID."' AND DATE_FORMAT(est.sale_date, '%Y-%m-%d') BETWEEN '" . $fromda . "' AND '" . $toda . "' ". $frans." ";
...

         {
            ...
            $bulkamt = floatval(0)  ;
			   ...
			   $tableBody .='	
                ...
                <td><span class="btn btn-primary  btn-sm">'.getStatus($data["order_status"]).'</span></td>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                      ...
                      <table id="estimateTable" class="table table-bordered table-striped dataTable dtr-inline">
                            ...
                            <tbody>
                            	...
                            	<?php echo getTable($_GET['cusid'],'erp_estimate_comm','erp_advance_comm',' erp_advance_bill_comm',$_GET['fromda'],$_GET['toda'],$_GET['fransid']);?>
                      ...
                      <table id="estimateTable" class="table table-bordered table-striped dataTable dtr-inline">
                            ...
                            <tbody>
                            	...
                            	<?php echo getTable($_GET['cusid'],'erp_estimate_noncomm','erp_advance_noncomm','erp_advance_bill_noncomm',$_GET['fromda'],$_GET['toda'],$_GET['fransid']);?>
