...
<button type="submit" name="submit" class="btn btn-info">Search</button>
                    ...
                    <form class="row" autocomplete="off" method="post" id="rmcyte_employee">
                        <div class="col-lg-12">
                            <h4 class="mb-3 mt-0"><?php echo $title; ?> Not Amount Received Reports</h4>
                        </div>
...
$(document).ready(function() {
    ...
    var dataRecords = $('#estimateTable').DataTable({
        ...
        buttons: [{
                ...
                title: 'Not Amount Received Reports',
        ...
        "footerCallback": function(row, data, start, end, display) {
            ...
            $(api.column(<?php echo ($_GET['typ'] == 1) ? 6 : 10; ?>).footer()).html('₹' + totalAmount.toFixed(2));
        }
    });
