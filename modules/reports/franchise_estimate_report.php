...
$obj_franchise = new Customer('', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', $GLOBALS["___mysqli_ston"]);
$getfranchise  = $obj_franchise->getAllFrachise();
$cus_data = array();
while ($cus_rows = mysqli_fetch_array($getfranchise)) {
    $cus_data[] = $cus_rows;
}

$getsize = $obj_franchise->getAllSize();
$size_data = array();
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <form class="row" autocomplete="off" method="post" id="rmcyte_employee">
                        <div class="col-lg-12">
                            <h4 class="mb-3 mt-0"><?php echo $title; ?> Franchise Reports</h4>
                        </div>
                        ...
                        <div class="col-lg-2 form-group">
                            ...
                            <select class="form-control txt_franchise_name " name="txt_franchise_name"
                                ...
                                <option value="<?php echo $cus_data[$i]['pk_cat_id']; ?>">
                                    <?php echo $cus_data[$i]['cat_name'] ; ?>
                                </option>
                                <?php }?>
                            </select>
...
/*$('#report_reset').on('click', function() {
    ...
    $('#txt_franchise_name').trigger('change');
...
var dataRecords = $('#estimateTable').DataTable({
    ...
    buttons: [{
        ...
        {
            extend: 'print',
            text: '<span class="mdi mdi-file-print"></span> Cutomer Print',
            title: 'Franchise Report',
            action: newexportaction1,
