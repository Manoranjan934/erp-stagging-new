        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3><?php echo getCount('erp_estimate_comm','count(PK_ES_ID)','sale_date=CURRENT_DATE');	;?><sup
                                ...
                                <?php echo formatNumber(getCount('erp_estimate_comm','sum(grand_total)','sale_date=CURRENT_DATE'),2);	;?><sup
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3><?php echo getCount('erp_invoice_comm','count(grand_total)','date=CURRENT_DATE');	;?><sup
                                    style="font-size: 20px">(Nos.)</sup> |
                                <?php echo formatNumber(getCount('erp_invoice_comm','sum(grand_total)','date=CURRENT_DATE'),2);?><sup
                                    style="font-size: 20px">(₹)</sup></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3><?php echo formatNumber(getCount('erp_advance_comm','sum(advance_amount)','date=CURRENT_DATE and type=0'),2);	;?><sup
                                    style="font-size: 20px">(₹)</sup></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3><?php echo formatNumber(getCount('erp_advance_comm','sum(advance_amount)','date=CURRENT_DATE and type=1'),2);	;?><sup
                                    style="font-size: 20px">(₹)</sup></h3>
            ...
            <div class="row">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3><?php echo getCount('erp_estimate_noncomm','count(PK_ES_ID)','sale_date=CURRENT_DATE');	;?><sup
                                    style="font-size: 20px">(Nos.)</sup> |
                                <?php echo formatNumber (getCount('erp_estimate_noncomm','sum(grand_total)','sale_date=CURRENT_DATE'),2);	;?><sup
                                    style="font-size: 20px">(₹)</sup></h3>
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3><?php echo getCount('erp_invoice_noncomm','count(grand_total)','date=CURRENT_DATE');	;?><sup
                                    style="font-size: 20px">(Nos.)</sup> |
                                <?php echo formatNumber (getCount('erp_invoice_noncomm','sum(grand_total)','date=CURRENT_DATE'),2);?><sup
                                    style="font-size: 20px">(₹)</sup></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3><?php echo formatNumber (getCount('erp_advance_noncomm','sum(advance_amount)','date=CURRENT_DATE and type=0'),2);	;?><sup
                                    style="font-size: 20px">(₹)</sup></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3><?php echo formatNumber (getCount('erp_advance_noncomm','sum(advance_amount)','date=CURRENT_DATE and type=1'),2);	;?><sup
                                    style="font-size: 20px">(₹)</sup></h3>
