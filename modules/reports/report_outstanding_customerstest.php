...
function getTable($customerID,$tableName,$payTable,$bulTable)
{
	$query = "SELECT est.PK_ES_ID, (est.grand_total) as totalAmt,est.sono, est.sale_date,est.order_status,est.delivery_date FROM ".$tableName." as est where est.customer_id='".$customerID."'";
		$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
         ...
         if( $outTotal > 0 && $bulkPay > 0)
         {
            ...
            $bulkamt = floatval(0)  ;
			   ...
			   $tableBody .='	
                ...
                <td><a href="index.php?erp=97&typ=1&cusid='.$data['pk_cus_id'].'" class="btn btn-primary  btn-sm">'.getStatus($data["order_status"]).'</a></td>
                              </tr>
                            ';
							$counter++;
            }
                ...
                <!-- DATA TABLE-->
                    ...
                    <div class="tab-content" id="nav-tabContent">
                      ...
                      <table id="estimateTable" class="table table-bordered table-striped dataTable dtr-inline">
                            ...
                            <tbody>
                            	<?php echo getTable($_GET['cusid'],'erp_estimate_comm','erp_advance_comm',' erp_advance_bill_comm');?>
                      ...
                      <table id="estimateTable" class="table table-bordered table-striped dataTable dtr-inline">
                            ...
                            <tbody>
                            	<?php echo getTable($_GET['cusid'],'erp_estimate_noncomm','erp_advance_noncomm','erp_advance_bill_noncomm');?>
