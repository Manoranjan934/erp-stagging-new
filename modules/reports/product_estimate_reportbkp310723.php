...
if(mysqli_num_rows($getAllitems1) > 0){
...
if(mysqli_num_rows($getAllitems2) > 0){
...
if(mysqli_num_rows($getAllitems3) > 0){
...
if(mysqli_num_rows($getAllitems6) > 0){
...
if(mysqli_num_rows($getAllitems7) > 0){
...
<form class="row" autocomplete="off" method="post" id="rmcyte_employee">
                        ...
                        <div class="col-lg-2 form-group">
                            ...
                            <select class="form-control txt_items_name " name="txt_items_name[]" id="txt_items_name" multiple>
                        ...
                        <div class="col-lg-2 form-group">
                            ...
                            <select class="form-control txt_items_category "  name="txt_items_category[]" id="txt_items_category" multiple>
                                <option  selected>ALL</option>
                        ...
                        <div class="col-lg-2 form-group">
                            ...
                            <select class="form-control txt_items_size " name="txt_items_size[]" id="txt_items_size" multiple>
                                <option selected>ALL</option>
                        ...
                        <div class="col-lg-2 form-group">
                            ...
                            <select class="form-control txt_items_bag " name="txt_items_bag[]" id="txt_items_bag" multiple>
                                <option selected>ALL</option>
                        ...
                        <div class="col-lg-2 form-group">
                            ...
                            <select class="form-control txt_items_box " name="txt_items_box[]" id="txt_items_box" multiple>
                                <option selected>ALL</option>
...
<script>
//var minDate, maxDate;
$('#txt_items_name').select2({    allowClear: true
});
