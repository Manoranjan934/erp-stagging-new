            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    ...
                    <form class="row" autocomplete="off" method="post" id="rmcyte_employee">
                        <div class="col-lg-12">
                            <h4 class="mb-3 mt-0"><?php echo $title; ?> Cash Reports</h4>
                        </div>
                        ...
                        <div class="col-lg-2 form-group">
                            ...
                            <select class="form-control txt_franchise_name " name="txt_franchise_name"
                                ...
                                <?php for ($j = 0; $j < count($fran_data); $j++) {?>
                                <option value="<?php echo $fran_data[$j]['pk_cat_id']; ?>">
                                    <?php echo $fran_data[$j]['cat_name']; ?>
                                </option>
                                <?php }?>
                            </select>
...
var dataRecords = $('#estimateTable_Cash').DataTable({
