        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Pad</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal theme-form" id="form_pad_Edit" novalidate="novalidate">
                <div class="card-body">
                  <div id="stepwizard">
                        <div class="one-half-column">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control txt_pad_id" name="txt_pad_id" id="txt_pad_id" placeholder="Auto" title=" Code" readonly="" value="<?php echo $rows['pk_pad_id']; ?>">
                              <span class="error" id="txt_pad_id_error"></span>
                            </div>
                          </div>-->
                          <input type="hidden" class="form-control txt_pad_id" name="txt_pad_id" id="txt_pad_id" value="<?php echo $rows['pk_pad_id']; ?>">
                      ...
                      <input type="hidden" name="mode" id="mode" value="EditPad">
