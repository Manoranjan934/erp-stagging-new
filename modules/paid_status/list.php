...
$getAllorderstatus = $obj_saleorder->getAllorderstatus();
...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>List Order Report </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">List Order Report</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr class="filters">
                                                ...
                                                <th style="border: unset;">Status:
                                                    <select id="status-filter" name="status-filter" class="form-control">
                                                        <option value="">All</option>
                                                         <?php if(!empty($getAllorderstatus) ){
                                                            while ($cus_rows = mysqli_fetch_array($getAllorderstatus)) {
                                                                
                                                              echo "<option value='".$cus_rows['id']."'>".$cus_rows['name']."</option>";  
                                                             }
                                                             }
                                                            ?>
...
<script
    src="assets/dist/js/paidstatus_serverdatatable_ajax.js?version=<?php echo md5_file('js/paidstatus_serverdatatable_ajax.js'); ?>">
</script>
...
$(".orderreport .nav-link").addClass("active");
