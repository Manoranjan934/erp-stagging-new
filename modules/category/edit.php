...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Mode / Franchise</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Edit Mode / Franchise</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                        ...
                        <div class="one-half-column">
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control txt_category_id" name="txt_category_id" id="txt_category_id" placeholder="Auto"  readonly="" value="<?php echo $rows['pk_cat_id']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control textOnly txt_cat_name" name="txt_cat_name" id="txt_cat_name" maxlength="50" placeholder="Mode / Franchise Name"  value="<?php echo $rows['cat_name']; ?>">
