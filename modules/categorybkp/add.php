                        ...
                        <div class="one-half-column">
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control txt_customer_code" name="txt_customer_code" id="txt_customer_code" placeholder="Auto" title="Category Code" readonly="">
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control textOnly txt_cat_name" name="txt_cat_name" id="txt_cat_name" maxlength="50" placeholder="Category Name" title="Category Name">
                            </div>
                          </div>
                          <div class="form-group">
