         ...
         WHERE visibility=1 ORDER BY cus_name ASC"
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <div class="tab-pane  " id="custom-tabs-one-complete" role="tabpanel" aria-labelledby="custom-tabs-one-complete-tab">
                    <table id="salesOrdercompleteTable" class="table table-bordered table-striped dataTable dtr-inline" style="width:100%">
                      <thead>
                        <tr>
...
<script src="assets/dist/js/status_table_ajax.js?version=<?php echo md5_file('js/status_table_ajax.js'); ?>"></script>
...
<script>
  $(document).ready(function() {
    ...
    $('#selectAll').on('click', function() {
      $('#salesOrderTable .estimateChk').prop('checked', $(this).prop('checked'));
    });
    ...
    $('#resetBtn').on('click', function(e) {
      ...
      $('#salesOrderTable').DataTable().ajax.reload(null, true);
    });
    ...
    $('#bulkUpdateBtn').on('click', function() {
      ...
      var bulkLink = $('<a>', {
        href: 'index.php?erp=34&typ=1&id=' + selected.join(','),
        style: 'display:none'
      }).appendTo('body');
