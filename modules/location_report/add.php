                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr class="filters">
                                                ...
                                                <th style="border: unset;">Location:
                                                    <select id="status-filter" name="status-filter" class="form-control">
                                                        <option value="">All</option>
                                                         <?php if(!empty($getAllCities) ){
                                                            while ($city_rows = mysqli_fetch_array($getAllCities)) {
                                                                
                                                              echo "<option value='".$city_rows['pk_city_id']."'>".$city_rows['city']."</option>";  
                                                             }
                                                             }
                                                            ?>
...
<script
    src="assets/dist/js/location_serverdatatable_ajax.js?version=<?php echo md5_file('js/location_serverdatatable_ajax.js'); ?>">
</script>
