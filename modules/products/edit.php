                ...
                <div class="card-body">
                  <div id="stepwizard">
                        <div class="one-half-column">
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control txt_product_code" name="txt_product_code" id="txt_product_code" placeholder="Auto" title="Code" readonly="" value="<?php echo $rows['pk_product_id'] ?>">
                         ...
                         <!-- <div class="form-group">
                            ...
                            <div class="control-field">
                              <select class="form-control txt_input_material capallfields" id="txt_input_category" name="txt_input_category" style="display: none;">
                                <option value="0" disabled="">Select Input Product Category</option>
                                <?php
                                for ($i=0; $i < count($cat_data); $i++) { 
                                   ?>
                                   <option <?php if($rows['fk_catgeory_id'] == $cat_data[$i]['pk_cat_id']){ echo 'selected'; } ?> value="<?php echo $cat_data[$i]['pk_cat_id']; ?>"><?php echo $cat_data[$i]['cat_name']; ?></option>
                                   <?php
                                 } 
                                ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                                 <input type="number" class="form-control txt_4color_price" name="txt_4color_price" id="txt_4color_price" maxlength="100" min="0" placeholder="4 Color Price" required="required" title="4 Color Price" value="<?php echo $rows['4color_price'] ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="number" class="form-control txt_7color_price" name="txt_7color_price" id="txt_7color_price" maxlength="100" min="0" placeholder="7 Color Price " required="required" title="7 Color Price"  value="<?php echo $rows['7color_price'] ?>">
                    ...
                    <!--      <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control textOnly txt_inner_sheet" name="txt_inner_sheet" id="txt_inner_sheet" maxlength="50" placeholder="Inner Sheet " title="Inner Sheet " value="<?php echo $rows['inner_sheet'] ?>">
                              <span class="error" id="txt_inner_sheet_error"></span>
                            </div>
                          </div>  <div class="form-group">
                            <label for="" class="control-label">Special Effects </label>
                            <div class="control-field">
                              <input type="text" class="form-control textOnly txt_special_effects" name="txt_special_effects" id="txt_special_effects" maxlength="50" placeholder="Special Effects" title="Special Effects" value="<?php echo $rows['special_effect'] ?>">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control textOnly txt_size" name="txt_size" id="txt_size" maxlength="50" placeholder="Size" title="Size" value="<?php echo $rows['size'] ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <select class="form-control txt_uom" name="txt_uom" id="txt_uom" required data-placeholder="SELECT UOM">
                                <option value="0" disabled="">Select UOM</option>
                                <?php
                                for ($i=0; $i < count($uom_data); $i++) { 
                                  ?>
                                  <option <?php if($rows['fk_uom_id'] == $uom_data[$i]['pk_uom_id']){ echo 'selected'; } ?> value="<?php echo $uom_data[$i]['pk_uom_id']; ?>"><?php echo $uom_data[$i]['uom_name']; ?></option>
                                  <?php
                                }
                                ?>
                              </select>
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="number" class="form-control txt_product_cgst" name="txt_product_cgst" id="txt_product_cgst" maxlength="100" min="0" placeholder="Product CGST" value="<?php echo ($rows['product_cgst'] > 0 ? $rows['product_cgst'] : '' ) ?>" title="Product CGST">
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="number" class="form-control txt_product_sgst" name="txt_product_sgst" id="txt_product_sgst" maxlength="100" min="0" placeholder="Product SGST" value="<?php echo ($rows['product_sgst'] > 0 ? $rows['product_sgst'] : '') ?>" title="Product SGST">
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="number" class="form-control txt_product_igst" name="txt_product_igst" id="txt_product_igst" maxlength="100" min="0" placeholder="Product IGST" value="<?php echo  ($rows['product_igst'] > 0 ? $rows['product_igst']:''); ?>" title="Product IGST">
                        ...
                        if(response == 1){
                            swal({
                              ...
                              buttons: false,
                                ...
                                window.location.href = "index.php?erp=6&id=<?php echo $_GET['id']; ?>";
                            });
                        }
                        else{
