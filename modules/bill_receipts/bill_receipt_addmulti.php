                    ...
                    <div class="card card-primary">
                        ...
                        <form class="form-horizontal theme-form" id="form_bill_comm_add" autocomplete="off"
                                ...
                                <div id="stepwizard">
                                   <div class="col-4">
                                      <!--  <div class="form-group">
                                            <label for="" class="control-label">Advance No </label>
                                    ...
                                    <!-- <div class="col-4 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="control-label">Franchise</label>
                                            <div class="control-field">
                                            <select class="form-control txt_franchise "
                                                        ...
                                                        <option value="<?php echo $fran_data[$i]['pk_cus_id']; ?>">
                                                            <?php echo $fran_data[$i]['cus_name']; ?></option>
                                                        <?php  } ?>
                                                    </select>
                                    ...
                                    <div class="table-div table-responsive">
                                        <table class="table-bordered table thead itemTable">
                                            ...
                                            <tbody class="itemclone custom_table_width">
                                                <tr>
                                                    <td><select class="form-control txt_item  txt_item_1"  name="txt_item[]" id="txt_item_1" data-czid="1" title=""></select></td>
                            ...
                            <div class="card-footer text-right">
								...
								<?php if($_GET['type']==1){ ?>
                                <input type="hidden" name="mode" value="addBillNonCommMulti" />
								<?php } elseif($_GET['type']==2){ ?>
								 <input type="hidden" name="mode" value="addBillNonCommMulti" />
								   <?php } ?>
    ...
    rules: {
		...
		adv_amount:{
			...
			remote: {
                        ...
                        type: "post",
                        data: {
							mode: "check_amount_billmulti",
                            adv_amount: function() {
                            return $( "#adv_amount" ).val();  
                          },
						  estimate_no: function() {
                            return $("#txt_estimate_name option:selected" ).text(); 
                          },
						  type: <?php echo $_GET['type']; ?>
                        }
                      } 
            ...
            success: function(response) {
                if (response) {
                    ...
                    swal({
                        ...
                        window.location.href = "index.php?erp=109&type=1";
                    });
					} else {
...
$('#form_bill_noncomm_add').validate({
    rules: {
        txt_customer_name: {
            required: true
        },
            ...
            success: function(response) {
                if (response) {
                    ...
                    swal({
                        ...
                        window.location.href = "index.php?erp=109&type=2";
                    });
					} else {
                    swal("Failed!", "Something went wrong, Try again!", "error");
                }
