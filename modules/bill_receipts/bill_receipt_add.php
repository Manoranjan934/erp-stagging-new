    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <?php if ($_GET['type'] == 1) { ?>
                        <h1>Add Commercial Bill Receipt</h1>
                    <?php } elseif ($_GET['type'] == 2) { ?>
                        <h1>Add NonCommercial Bill Receipt</h1>
                    <?php } ?>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Add Bill Receipt</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <?php if ($_GET['type'] == 1) { ?>
                            <form class="form-horizontal theme-form" id="form_bill_comm_add" autocomplete="off"
                                novalidate="novalidate">
                            <?php } elseif ($_GET['type'] == 2) { ?>
                                <form class="form-horizontal theme-form" id="form_bill_noncomm_add" autocomplete="off"
                                    novalidate="novalidate">
                                <?php } ?>
                                <div class="card-body">
                                    <div id="stepwizard">
                                        ...
                                        <div class="col-4 col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="control-field">
                                                    <input type="number" class="form-control adv_amount" name="adv_amount"
                                                        id="adv_amount" min="1">
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <span class="col-md-2">
                                        ...
                                        <?php if ($_GET['type'] == 1) { ?>
                                            <input type="hidden" name="mode" value="addBillcomm" />
                                        <?php } elseif ($_GET['type'] == 2) { ?>
                                            <input type="hidden" name="mode" value="addBillNonComm" />
                                        <?php } ?>
...
<script>
    ...
    $('#form_bill_comm_add').on('keyup keypress', function(e) {
    ...
    var validatorBill = $('#form_bill_comm_add').validate({
        rules: {
            txt_customer_name: {
                required: true
            },
        ...
        submitHandler: function(form) {
            ...
            var formData = new FormData($('#form_bill_comm_add')[0]);
            $.ajax({
                url: "modules/bill_receipts/ajax_functions.php",
                data: formData,
                type: 'post',
...
<script>
    ...
    $('#form_bill_noncomm_add').on('keyup keypress', function(e) {
        var keyCode = e.keyCode || e.which;
        if (keyCode === 13) {
            e.preventDefault();
            return false;
    ...
    var validatorBill = $('#form_bill_noncomm_add').validate({
        rules: {
            txt_customer_name: {
                required: true
            },
        ...
        submitHandler: function(form) {
            var formData = new FormData($('#form_bill_noncomm_add')[0]);
            $.ajax({
                url: "modules/bill_receipts/ajax_functions.php",
                data: formData,
                type: 'post',
    ...
    $('#txt_estimate_name').on('change', function() {
        ...
        var esttxt = $('#txt_estimate_name').find('option:selected').text();
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(response) {
                // $('#txt_estimate_name').prop("disabled", false);
                $("option").prop("disabled", false)
                $('#addbillstatusMSSG').empty();
                if (response == 'true') {

                    $('option[value="' + estid + '"]').prop('disabled', !$('option[value="' + estid + '"]').prop('disabled'));

                    $('#addbillstatusMSSG').html('<div class="addbillstMSSG"><i class="fa fa-exclamation-circle" style="font-size:20px;color:#dfd6d6"><span style="margin: 3px;">Kindly change the status of the estimate  "DELIVERED"  before adding bill receipts. (' + esttxt + ')</span></i></div>');
                    // $('#txt_estimate_name').select2('val','');
                    // $("#txt_estimate_name").val(null).trigger("change"); 
                    //  $("#txt_estimate_name").select2("destroy").select2();
