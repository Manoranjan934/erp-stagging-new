...
<div class="content-wrapper" style="min-height: 1342.88px;">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="mb-2 text-right">
                      <a href="index.php?erp=110&type=1" class="btn btn-primary"><i class="fa fa-plus mr-2" aria-hidden="true"></i> Add New Commercial Bill Receipts</a>
                    </div>
		  <?php } elseif($_GET['type']==2){ ?>
		 <div class="mb-2 text-right">
                      <a href="index.php?erp=110&type=2" class="btn btn-primary"><i class="fa fa-plus mr-2" aria-hidden="true"></i> Add New NonCommercial Bill Receipts</a>
                    </div>
		  <?php } ?>
                    <nav>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                      <div class="tab-pane fade show active" id="nav-waiting" role="tabpanel" aria-labelledby="nav-waiting-tab">
                        <table id="com_billmultiTable" class="table table-bordered table-striped dataTable dtr-inline">
                            <thead>
                            <tr>
                                <th>S.No </th>
                                <th>So.No</th>
					...
					<div class="tab-content" id="nav-tabContent">
                      <div class="tab-pane fade show active" id="nav-waiting" role="tabpanel" aria-labelledby="nav-waiting-tab">
                        <table id="noncom_billmultiTable" class="table table-bordered table-striped dataTable dtr-inline">
                            <thead>
                            <tr>
                                 <th>S.No </th>
                                <th>So.No</th>
  ...
  <script src="assets/dist/js/noncommer_table_ajax.js?version=<?php echo md5_file('js/noncommer_table_ajax.js');?>"></script>
