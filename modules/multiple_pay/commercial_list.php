                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-right">
                                <a href="index.php?erp=80&type=1" class="btn btn-primary"><i class="fa fa-plus mr-2"
                                        aria-hidden="true"></i> Add New Commercial Advance</a>
                            </div>
                            <?php } elseif ($_GET['type'] == 2) {?>
                            <div class="mb-2 text-right">
                                <a href="index.php?erp=80&type=2" class="btn btn-primary"><i class="fa fa-plus mr-2"
