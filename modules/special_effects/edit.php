...
$obj_se->setid($_GET['id']); 
$getcate = $obj_se->geteditSpecialeffects();
...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Special Effects</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Edit Special Effects</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal theme-form" id="form_specialeffects_Edit" novalidate="novalidate">
                <div class="card-body">
                  <div id="stepwizard">
                        <div class="one-half-column col-md-12">
                          <div class="form-group">
                            <label for="" class="control-label">Code </label>
                            <div class="control-field">
                              <input type="text" class="form-control txt_id" name="txt_id" id="txt_id" placeholder="Auto" title=" Code" readonly="" value="<?php echo $rows['pk_se_id']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="control-field">
                              <input type="text" class="form-control textOnly txt_cost" name="txt_cost" id="txt_cost" maxlength="50" placeholder=" Cost" title=" Cost" value="<?php echo $rows['cost']; ?>">
                      ...
                      <input type="hidden" name="mode" id="mode" value="EditSpecialeffects">
