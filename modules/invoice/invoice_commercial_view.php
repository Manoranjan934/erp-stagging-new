            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="text-right mb-2">
                        <a href="print_pdf/print_report_SI.php?soid=<?php echo $_GET['id']; ?>" class="btn btn-primary"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <textarea class="form-control txt_remarks" name="txt_remarks"
                                                    style="height: 77px !important;" id="txt_remarks" readonly></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <select class="form-control txt_intstate " onchange="cal()"
                                                    name="txt_intstate" id="txt_intstate" readonly>
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field4" 
                                                                            class="form-control  pull-left discount_field4" readonly></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field5" 
                                                                            class="form-control  pull-left discount_field5" readonly></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
        ...
        success: function(response) {
            ...
            setTimeout(function() {
              //  var so_idval = so_id.split('#');
                ...
                $('.txt_sc_no').val(so_id).attr("selected", true);
