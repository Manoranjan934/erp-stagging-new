                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <a style="border: 1px solid;padding: 3px 9px;" href="index.php?erp=16&id=<?php echo $_GET['id']; ?>"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
                            ...
                            <div class="card-footer text-right">
                                <input type="hidden" name="mode" value="updateSalesInvoiceBetaV1">
            ...
            success: function(response) {
                if (soid == 0) {
                    ...
                    for (j = 0; j < response[1].length; j++) {
                        ...
                        $('table .itemclone').append(
                            '<tr><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + vz + ' "   name="txt_itemtypes[]" id="txt_itemtypes_' + vz + '"  data-czid="' + vz + '" data-classids="txt_itemtypes_' + vz + '" value="' + response[1][j].fk_types_id + '">' + response[1][j].types_name + '</td><td ><select  class="form-control txt_item  txt_item_' +
                ...
                success: function(response) {
                    if (response) {
                        swal({
                            ...
                            window.location.href = "index.php?erp=143";
