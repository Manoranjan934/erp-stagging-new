...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Add Commercial Invoice</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Add Commercial Invoice</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal theme-form" id="form_invoice_comm_add" autocomplete="off"
...
?>
                                ...
                                <input type="hidden" name="mode" id="mode" value="AddInvoice">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="table-div table-responsive">
                                        <table class="table-bordered table thead itemTable">
                                            ...
                                            <tr>
                                                    <td><select class="form-control txt_item  txt_item_1"  name="txt_item[]" id="txt_item_1" data-czid="1" ></select></td>
                            ...
                            <div class="card-footer text-right">
                                <span style="float: left;" class="col-md-8"><p id="advanceinfomsg" style=" text-align: center;color:#ff0000;font-size:14px"></p></span>
                                <span class="col-md-2">
                                <input type="hidden" name="deleted" value="0" id="deleted" />
                                <input type="hidden" name="mode" value="addSalesInvoice" />
...
$('#form_invoice_comm_add').on('keyup keypress', function(e) {
...
function getTypesListing(type) {
    //alert('test');
    $.ajax({
        url: "modules/products/commercial_ajax_functions.php",
        data: {
...
function getComercialorNonItemsTypeEdit(itemid, zz) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        success: function(response) {
            $('.txt_item_' + zz).html('<option selected >SELECT ONE</option>');
            $('.itemsdata').show();
            for (var i = 0; i < response[0].length; i++) {
                if (response[0][i].pk_items_id == '9999') {
                    //  type_tables, table_pk_id, orderid
...
$('#form_invoice_comm_add').validate({
    rules: {
        txt_customer_name: {
            required: true
        },
    ...
    submitHandler: function(form) {
        var formData = new FormData($('#form_invoice_comm_add')[0]);
        $.ajax({
            url: "modules/invoice/commercial_ajax_functions.php",
            data: formData,
            type: 'post',
            ...
            success: function(response) {
                if (response) {
                    swal({
                        ...
                        //window.location.href = "index.php?erp=72";
...
$('#form_sales_invoice_add').on('keyup keypress', function(e) {
    var keyCode = e.keyCode || e.which;
    if (keyCode === 13) {
        e.preventDefault();
        return false;
