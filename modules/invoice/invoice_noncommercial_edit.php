...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Non Commercial Invoice </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Edit Non Commercial Invoice</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal theme-form" id="form_invoice_noncomm_edit" novalidate="novalidate">
                            <div class="card-body">
                                <div id="stepwizard">
                        ...
                        <a style="border: 1px solid;padding: 3px 9px;" href="index.php?erp=16&id=<?php echo $_GET['id']; ?>"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="control-label"> Delivery Date <span
                                                    class="color">*</span></label>
                                            <div class="control-field">
                                    ...
                                    <div class="col-4 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="control-label">Street/Area <span
                                                    class="color">*</span></label>
                                            <div class="control-field">
                                            ...
                                            <tbody class="itemclone custom_table_width">
                                                <tr>
                                                    ...
                                                    <td><input
                                                            ...
                                                            name="txt_product_qty[]" placeholder="Quantity"></td>
                                                    <td><select class="form-control txt_price_type txt_price_type_1 "
                                                            data-czid="1" name="txt_price_type[]" id="txt_price_type_1"></select></td>
                                                    ...
                                                    <td><input type="text" name="txt_price[]" id="txt_price_1"
                                                            ...
                                                            class="form-control pricefield txt_price txt_price_1 numberss text-right"><input type="hidden"
                                                            class="txt_comm txt_comm_1" name="txt_comm" id="txt_comm"
                                                            value="" onkeyup="cal()"></td>
                                                    <td><input type="text" name="txt_final_total[]"
                                                            id="txt_final_total_1"
                                                            class="form-control txt_final_total_1 numberss txt_final_total text-right"></td>
                                                            ...
                                                            <td class="text-right">
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        name="discount_type1" id="discount_type1" onchange="cal()">
                                                                        <option value="1" selected="">+</option>
                                                                        <option value="2">-</option>
                                                                    </select>
                                                                </span>
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field2"
                                                                            class="form-control  pull-left discount_field2" onkeyup="cal()"></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        name="discount_type2" id="discount_type2" onchange="cal()">
                                                                        <option value="1" selected="">+</option>
                                                                        <option value="2">-</option>
                                                                    </select>
                                                                </span>
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field3"
                                                                            class="form-control  pull-left discount_field3" onkeyup="cal()"></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        name="discount_type3" id="discount_type3" onchange="cal()">
                                                                        <option value="1" selected="">+</option>
                                                                        <option value="2">-</option>
                                                                    </select>
                                                                </span>
...
<script>
    $('#form_invoice_noncomm_edit').on('keyup keypress', function(e) {
    ...
    if (getQueryVariable('id')) {
        ...
        getSIEditValues(soid);
    }


    /*get sales order values edit page */
    function getSIEditValues(soid) {
        $.ajax({
            ...
            success: function(response) {
                if (soid == 0) {
                    ...
                    $('.txt_customer_name').find('option[value="' + response[0].fk_customer_id + '"]').attr("selected", true);
                    ...
                    for (j = 0; j < response[1].length; j++) {
                        ...
                        $('table .itemclone').append(
                            '<tr data-type_id="' + response[1][j].fk_types_id + '"><td><input type="hidden" name="group_id[]" value="' + group_id + '"><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + vz + ' "   name="txt_itemtypes[]" id="txt_itemtypes_' + vz + '"  data-czid="' + vz + '" data-classids="txt_itemtypes_' + vz + '" value="' + response[1][j].fk_types_id + '">' + response[1][j].types_name + '</td><td ><select  class="form-control txt_item  txt_item_' +
                            ...
                            '"   ><option value="">Select Orientation</option><option value="1">landscape</option><option value="2">portrait</option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
                            vz + '"  class="form-control pricefield txt_price txt_price_' +
                            vz + ' numberss text-right"  value=' + response[1][j].sep_price +
                        ...
                        // getTypesListingEdit(response[1][j].itemtype, vz, response[1][j].fk_item_id, response[1][j].types);
                        getComercialorNonItemsTypeEdit(response[1][j].fk_item_id, vz, response[1][j].fk_types_id);
    ...
    function getComercialorNonItemsType(type) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(response) {
                $('.txt_item_' + type).html('<option value="0" selected disabled>SELECT ONE</option>');
                $('.itemsdata').show();
                for (var i = 0; i < response[0].length; i++) {
                    if (response[0][i].pk_items_id == '9999') {
                        //  type_tables, table_pk_id, orderid
    ...
    function getCostTypeListing(types) {
        ...
        if (typesval == 1) {
            ...
            $('.txt_price_type_' + types).append('<option value="1">4 Color</option><option value="2">7 Color</option><option value="">NONE</option>');
    ...
    function getCostTypeListingEdit(pricetype, zz) {
        ...
        if (typesval == 1) {
            ...
            $('.txt_price_type_' + zz).append('<option value="1">4 Color</option><option value="2">7 Color</option><option value="">NONE</option>');
    ...
    function getComercialorNonItemsTypeEdit(itemid, zz, itemtype) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(response) {
                $('.txt_item_' + zz).html('<option value="0" selected disabled>SELECT ONE</option>');
                //  $('.itemsdata').show();
                for (var i = 0; i < response[0].length; i++) {
                    if (response[0][i].pk_items_id == '9999') {
                        //  type_tables, table_pk_id, orderid
    ...
    */
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                setTimeout(function() {
                    ...
                    console.log("so_idval=>", so_idval);

                    //$('.txt_sc_no').find('option[value="1,2"]').attr("selected", true);
                    // $('.txt_sc_no').val(so_idval).attr("selected", true).trigger('change');
                    $('.txt_sc_no').val(so_idval).trigger('change');
    ...
    function cal() {
        ...
        $('.itemTable >tbody >tr').each(function(index, row) {
            ...
            // console.log(qty, '*', price, '=', total_total_amount);
...
*/
    ...
    $('#txt_customer_name').on('change', function() {
        ...
        getJobOrder(custId);
        // $('#form_invoice_noncomm_edit')[0].reset();
    ...
    $('#form_invoice_noncomm_edit').validate({
        rules: {
            txt_customer_name: {
                required: true
            },
        ...
        submitHandler: function(form) {
            ...
            // return;
            var formData = new FormData($('#form_invoice_noncomm_edit')[0]);
            $.ajax({
                url: "modules/invoice/noncommercial_ajax_functions.php",
                data: formData,
                type: 'post',
                ...
                success: function(response) {
                    if (response) {
                        swal({
                            ...
                            window.location.href = "index.php?erp=79";
                            // window.location.href = "print_pdf/print_report_SI.php?soid=" + response + "";
    ...
    function getCity(city_id) {
        ...
        $.post("modules/invoice/noncommercial_ajax_functions.php", {
                mode: 'getAllCities',
            },
