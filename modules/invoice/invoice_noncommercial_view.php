...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>View Non Commercial Invoice </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">View Non Commercial Invoice</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="text-right mb-2">
                        <a href="print_pdf/print_report_SINON.php?soid=<?php echo $_GET['id']; ?>" class="btn btn-primary"
            ...
            if (soid == 0) {
             ...
             /*   $('#discount_final5').val(parseFloat(response[0].discount_final5).toFixed(2));
                ...
                for (j = 0; j < response[1].length; j++) {
                   ...
                   if(response[1][j].fk_item_id > 0){
                     $('table .itemclone').append(
                        '<tr><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_'+vz+' "   name="txt_itemtypes[]" id="txt_itemtypes_'+vz+'" title="Item Types" data-czid="'+vz+'" data-classids="txt_itemtypes_'+vz+'" value="'+ response[1][j].fk_types_id+'">'+ response[1][j].types_name+'</td><td ><select  class="form-control txt_item  txt_item_' +
