        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal theme-form" id="form_invoice_comm_edit" novalidate="novalidate">
                            <div class="card-body">
                                <div id="stepwizard">
                        ...
                        <a style="border: 1px solid;padding: 3px 9px;" href="index.php?erp=16&id=<?php echo $_GET['id']; ?>"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
                                    ...
                                    <div class="col-4 col-md-12">
                                        ...
                                        <label for="" class="control-label">Invoice No </label>
                                            <div class="control-field">
                                                <input type="text" class="form-control txt_seno" value=""
                                                    name="txt_seno" id="txt_seno" placeholder="Auto" title="SI NO"
                                                    readonly="">
                                                <span class="error" id="txt_seno_error"></span>
                                            </div>
                                        </div>
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field4" 
                                                                            class="form-control  pull-left discount_field4" onkeyup="cal()"></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        name="discount_type4" id="discount_type4" onchange="cal()">
                                                                        <option value="1" selected="">+</option>
                                                                        <option value="2">-</option>
                                                                    </select>
                                                                </span>
                                                                ...
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <label class=""
                                                                        style="    padding-right: 15px;"><input
                                                                            ...
                                                                            id="discount_field5" 
                                                                            class="form-control  pull-left discount_field5" onkeyup="cal()"></label>
                                                                    <div class="input-group btn-type w-49"
                                                                        style="margin-right: 20px !important;width: 30% !important;">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        name="discount_type5" id="discount_type5" onchange="cal()">
                                                                        <option value="1" selected="">+</option>
                                                                        <option value="2">-</option>
                                                                    </select>
                                                                </span>
                                                            ...
                                                            <td class="text-right">
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        name="txt_cal_type_sgst" id="txt_cal_type_sgst" readonly>
                                                                        <option value="1" selected="">+</option>
                                                                        <!-- <option value="2">-</option> -->
                                                                    </select>
                                                            ...
                                                            <td class="text-right">
                                                                <span class="totalamounts_sec mt-10 "
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        name="txt_cal_type_igst" id="txt_cal_type_igst" readonly>
                                                                        <option value="1" selected="">+</option>
                                                                        <!-- <option value="2">-</option> -->
                                                                    </select>
...
if (getQueryVariable('id')) {
    ...
    $('table.itemTable tbody.itemclone').html(
          /*  '<tr><td><select class="form-control txt_product_name txt_product_name_1 chosen_required" name="txt_product_name[]" id="txt_product_name_1" data-czid="1" title="Product" required="" aria-required="true"></select></td> <td><select class="form-control txt_category txt_category_1 chosen_required"  name="txt_category[]" id="txt_category_1" title="Category" required="" aria-required="true"></select></td><td><select class="form-control txt_itemtypes txt_itemtypes_1 chosen_required" name="txt_itemtypes[]" id="txt_itemtypes_1" title="Types" data-czid="1" data-classids="txt_itemtypes_1"></select><input type="hidden" name="pro_type[]" id="pro_type" class="pro_type pro_type_1"></td><td class="itemsdata" style="display:none"><select  class="form-control txt_item  txt_item_1" name="txt_item[]" id="txt_item_1" data-czid="1"  title="" ></select></td><td><input onkeyup="cal()"  class="form-control txt_product_qty numbersOnly  txt_product_qty_1" min="0" max="999999" id="txt_product_qty_1" name="txt_product_qty[]" placeholder="Quantity" title="Quantity"></td><td ><input type="text" name="txt_price[]" id="txt_price_1" onkeyup="cal()" class="form-control pricefield txt_price txt_price_1 numberss text-right" title="Price"><input type="hidden" class="txt_comm txt_comm_1" name="txt_comm" id="txt_comm" value=""></td><td ><input type="text" name="txt_final_total[]" id="txt_final_total_1" class="form-control txt_final_total_1 numberss txt_final_total text-right" title="Grand Total" readonly></td><td><button type="button" name="removeitems" id="removeitems" class="btn btn-danger removeitems" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td></tr>'*/
            '<tr><td><select class="form-control txt_product_name txt_product_name_1 chosen_required" name="txt_product_name[]" id="txt_product_name_1" data-czid="1"  required="" aria-required="true"></select></td> <td><select class="form-control txt_category txt_category_1 chosen_required"  name="txt_category[]" id="txt_category_1"  required="" aria-required="true"></select></td><td><select class="form-control txt_itemtypes txt_itemtypes_1 chosen_required" name="txt_itemtypes[]" id="txt_itemtypes_1"  data-czid="1" data-classids="txt_itemtypes_1"></select><input type="hidden" name="pro_type[]" id="pro_type" class="pro_type pro_type_1"></td><td ><select  class="form-control txt_item  txt_item_1" name="txt_item[]" id="txt_item_1" data-czid="1"   ></select></td><td><input   class="form-control txt_product_qty numbersOnly  txt_product_qty_1" min="0" max="999999" id="txt_product_qty_1" name="txt_product_qty[]" placeholder="Quantity" ></td><td ><input type="text" name="txt_price[]" id="txt_price_1"  class="form-control pricefield txt_price txt_price_1 numberss text-right" ><input type="hidden" class="txt_comm txt_comm_1" name="txt_comm" id="txt_comm" value=""></td><td ><input type="text" name="txt_final_total[]" id="txt_final_total_1" class="form-control txt_final_total_1 numberss txt_final_total text-right" readonly></td><td><button type="button" name="removeitems" id="removeitems" class="btn btn-danger removeitems" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td></tr>'
        );
    }
...
$('#form_invoice_comm_edit').validate({
    rules: {
        txt_customer_name: {
            required: true
        },
    ...
    submitHandler: function(form) {
        var formData = new FormData($('#form_invoice_comm_edit')[0]);
        $.ajax({
            url: "modules/invoice/commercial_ajax_functions.php",
            data: formData,
            type: 'post',
            async: false,
            dataType: 'json',
            success: function(response) {
                if (response) {
                    swal({
                        ...
                        window.location.href = "index.php?erp=75";
             ...
             /*   $('#discount_final5').val(parseFloat(response[0].discount_final5).toFixed(2));
               ...
               // $('#txt_gst_total').val(parseFloat(response[0].gst_total).toFixed(2));
                ...
                for (j = 0; j < response[1].length; j++) {
                    vz++;
                    $('table .itemclone').append( '<tr><td ><select  class="form-control txt_item  txt_item_' +
                    ...
                    $('.txt_orientation_' + vz).find('option[value="' + response[1][j].orientation + '"]').attr("selected", true);
                        ...
                        getComercialorNonItemsTypeEdit(response[1][j].fk_item_id, vz);
                ...
                for (j = 0; j < response[1].length; j++) {
                 ...
                 /*   getProductListingsEdit(response[1][j].product_id, vz);
                   ...
                   // getTypesListingEdit(response[1][j].itemtype, vz, response[1][j].fk_items_id, response[1][j].types);
                    getComercialorNonItemsTypeEdit(response[1][j].fk_items_id, vz);
...
$('#txt_customer_name').on('change', function() {
    ...
    getJobOrder(custId);
    //$('#form_invoice_comm_edit')[0].reset();
});
