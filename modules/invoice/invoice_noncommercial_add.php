...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Add Non Commercial Invoice</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Add Non Commercial Invoice</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal theme-form" id="form_invoice_noncomm_add" autocomplete="off"
                            ...
                            <div class="card-body">
                                <div id="stepwizard">
                                    ...
                                    <div class="col-4 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="control-label">Street/Area </label>
                                            <div class="control-field">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="control-field">
                                                <select class="form-control txt_intstate " onchange="cal()"
                                                    ...
                                                    <option value="2" selected>Exclusive of GST</option>
                                        ...
                                        <table class="table-bordered table thead itemTable">
                                            ...
                                            <tbody class="itemclone custom_table_width">
                                                ...
                                                while ($types_rows = mysqli_fetch_array($gettypes)) {
                                                    ...
                                                    echo '<tr><td><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' . $i . ' "   name="txt_itemtypes[]" id="txt_itemtypes_' . $i . '"
                                                ...
                                                <td><select class="form-control txt_orientation txt_orientation_' . $i . '"
                                                        name="txt_orientation[]" id="txt_orientation_' . $i . '"
                                                         onchange="cal()">';
                                                    if ($types_rows['pk_types_id'] == 1) {
                                                        echo   '<option value="">Select Orientation</option>
                                                        <option value="1">Length</option><option value="2">Breadth </option><option value="">NONE </option>';
                                                    } else {
                                                        echo   '<option value="">NONE </option>';
                                                    }

                                                    echo   '</select></td>
                                                <td><input type="text" name="txt_price[]" id="txt_price_' . $i . '"
                                                        onkeyup="cal()"
                            ...
                            <div class="card-footer text-right">
                                ...
                                <span class="col-md-2">
                                    ...
                                    <input type="hidden" name="mode" value="addInvoiceNonComm" />
                                    <input type="hidden" name="cus_id" id="cus_id">
                                    <button type="submit" class="btn_save btn btn-success btn-lg">Save</button></span>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
<script>
    ...
    $(".invoice_noncommercial .nav-link").addClass("active");
    ...
    function getCostTypeListing(zz) {

        $('.txt_price_type_' + zz).html('<option selected >SELECT ONE </option>');
    ...
    function getCostTypeListingEdit(pricetype, zz) {
        ...
        $('.txt_price_type').html('<option selected >SELECT ONE </option>');
        $('.txt_price_type').append('<option value="1">Price (or) 4 Color</option><option value="2">Price (or) 7 Color</option><option value="">NONE</option>');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                setTimeout(function() {
                    ...
                    getComercialorNonItemsTypeEdit(item_id, zz, proid);
    ...
    function getComercialorNonItemsTypeEdit(itemid, zz, itemtype) {
    ...
    function addrow() {
        ...
        $('table .itemclone').append('<tr><td><select class="form-control txt_types txt_types_' + zz +
            ...
            '"   ></select></td><td><input onkeyup="cal()"  class="form-control txt_product_qty numbersOnly  txt_product_qty_' +
            ...
            '"   ><option value="">Select Orientation</option><option value="1">Length</option><option value="2">Breadth </option></select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
            zz + '" onkeyup="cal()" class="form-control pricefield txt_price txt_price_' + zz +
            ' numberss text-right" ><input type="hidden" class="txt_comm txt_comm_' + zz +
        ...
        $.ajax({
            ...
            success: function(response) {
                if (soid == 0) {
                    ...
                    $('.txt_state').find('option[value="' + response[0].city + '"]').attr("selected", true);
                    ...
                    var pendingamt = parseFloat(response[0].grand_total);
                    var advanceamt = 0;
                    $('#advanceinfomsg').empty();
                    if (response[0].advance > 0) {
                        pendingamt = parseFloat(response[0].grand_total) - parseFloat(response[0].advance);
                        advanceamt = parseFloat(response[0].advance);
                    }
                    $('#advanceinfomsg').append('Advance amount is: <b>' + advanceamt + '</b> <br/>  Pending amount is: <b>' + pendingamt + '</b> ')
                    ...
                    for (j = 0; j < response[1].length; j++) {
                        ...
                        var group_id = response[1][j].group_id;

                        $('table .itemclone').append(
                            '<tr data-type_id="' + response[1][j].itemtype + '"><td><input type="hidden" name="group_id[]" value="' + group_id + '"><input type="hidden" class="form-control txt_itemtypes txt_itemtypes_' + vz + ' "   name="txt_itemtypes[]" id="txt_itemtypes_' + vz + '"  data-czid="' + vz + '" data-classids="txt_itemtypes_' + vz + '" value="' + response[1][j].itemtype + '">' + response[1][j].types_name + '</td><td ><select  class="form-control txt_item  txt_item_' + vz + '" name="txt_item[]" id="txt_item_' + vz + '" data-czid="' + vz +
                            ...
                            '"  name="txt_product_qty[]" placeholder="Quantity"   value=' +
                            response[1][j].qty +
                            '  onkeyup="cal()"></td><td><select class="form-control txt_price_type txt_price_type_' + vz +
                            ...
                            '"    onkeyup="cal()">' + hideorient + '</select></td><td ><input type="text" name="txt_price[]" id="txt_price_' +
                            vz + '"  class="form-control pricefield txt_price txt_price_' +
                            vz + ' numberss text-right"  value=' + response[1][j].price +
                            '  onkeyup="cal()"><input type="hidden" class="txt_comm txt_comm_' + vz +
                            '" name="txt_comm" id="txt_comm" value=""></td><td ><input type="text" name="txt_final_total[]" id="txt_final_total_' +
                        ...
                        getComercialorNonItemsTypeEdit(response[1][j].fk_items_id, vz, response[1][j].itemtype);
                        //   getTypesListingEdit(response[1][j].itemtype, vz, response[1][j].fk_items_id);
    ...
    $('#txt_customer_name').on('change', function() {
        ...
        customerBaseDetails(custId);

        getJobOrder(custId);
        //  $('#form_invoice_noncomm_add')[0].reset();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0; i < response.length; i++) {
                    $('#txt_sc_no').append('<option value="' + response[i].PK_ES_ID + '">' + response[i]
                        .sono + '</option>');
                }
            },
            error: function(response) {
    ...
    function cal() {
        ...
        var discount_final1 = $("#discount_final1").find("option:selected").val();
    ...
    function customerBaseDetails(cusId) {
    ...
    $('#form_invoice_noncomm_add').validate({
        rules: {
            txt_customer_name: {
                required: true
            },
        ...
        submitHandler: function(form) {
            ...
            // return;
            var formData = new FormData($('#form_invoice_noncomm_add')[0]);
            $.ajax({
                url: "modules/invoice/noncommercial_ajax_functions.php",
                data: formData,
                type: 'post',
                ...
                success: function(response) {
                    if (response) {
                        swal({
                            ...
                            window.location.href = "print_pdf/print_report_SINON.php?soid=" + response + "";
                            //window.location.href = "index.php?erp=76";
                        });
                    } else {
