...
<div class="content-wrapper" style="min-height: 1342.88px;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>List Non Commercial Invoice </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">List Non Commercial Invoice</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <h3 class="card-title">Quick Example <small>jQuery Validation</small></h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2 text-right">
                                <a href="index.php?erp=76" class="btn btn btn-primary "><i
...
<script src="assets/dist/js/invocie_noncomm_ajax.js?version=<?php echo md5_file('js/invocie_noncomm_ajax.js'); ?>">
</script>
