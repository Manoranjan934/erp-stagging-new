        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="mb-2 text-right">
                      <a href="index.php?erp=108&type=1" class="btn btn-primary"><i class="fa fa-plus mr-2" aria-hidden="true"></i> Add New Commercial Advance</a>
                    </div>
		  <?php } elseif($_GET['type']==2){ ?>
		 <div class="mb-2 text-right">
                      <a href="index.php?erp=108&type=2" class="btn btn-primary"><i class="fa fa-plus mr-2" aria-hidden="true"></i> Add New NonCommercial Advance</a>
                    </div>
		  <?php } ?>
                    <nav>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                      <div class="tab-pane fade show active" id="nav-waiting" role="tabpanel" aria-labelledby="nav-waiting-tab">
                        <table id="com_advancemultiTable" class="table table-bordered table-striped dataTable dtr-inline">
                            <thead>
                            <tr>
                                <th>S.No </th>
                                <th>So.No</th>
					...
					<div class="tab-content" id="nav-tabContent">
                      <div class="tab-pane fade show active" id="nav-waiting" role="tabpanel" aria-labelledby="nav-waiting-tab">
                        <table id="noncom_advancemultiTable" class="table table-bordered table-striped dataTable dtr-inline">
                            <thead>
                            <tr>
                                 <th>S.No </th>
                                <th>So.No</th>
