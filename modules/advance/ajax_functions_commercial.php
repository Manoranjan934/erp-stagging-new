...
if(isset($_POST['mode']) && $_POST['mode']=='editAdvancecomm'){
...
//	$obj_advancecommornon->setsono($soNum);
	...
	$result = $obj_advancecommornon->edit_advance_comm($ad_date);
...
if(isset($_POST['mode']) && $_POST['mode']=='get_estimate_all'){

	

  $result = $obj_advancecommornon->getAllEstimate_comm($_POST['customer']);
...
if(isset($_POST['mode']) && $_POST['mode']=='check_amount'){
...
if($_POST['estimate_no'] == "Select Estimate"){
  ...
  $result = $obj_advancecommornon->check_pending_amount_comm($_POST['estimate_no'],$_POST['adv_amount']);

	}elseif($_POST['type']==2){

		$result = $obj_advancecommornon->check_pending_amount_noncomm($_POST['estimate_no'],$_POST['adv_amount']);
...
if(isset($_POST['mode']) && $_POST['mode']=='check_amount_by_esid'){
...
if($_POST['estimate_no'] == "Select Estimate"){
  ...
  $result = $obj_advancecommornon->check_pending_amount_comm_by_esid($_POST['estimate_no'],$_POST['adv_amount']);

	}elseif($_POST['type']==2){

		$result = $obj_advancecommornon->check_pending_amount_noncomm_by_esid($_POST['estimate_no'],$_POST['adv_amount']);
...
//  $obj_advancecommornon->setdiscount_type5($_POST['discount_type5']);
	...
	if(isset($_POST['mode']) && $_POST['mode'] == 'listAdvanceComm') {
        ...
        $obj_advancecommornon->listAdvanceComm();
	...
	if(isset($_POST['mode']) && $_POST['mode'] == 'getAdvanceEditValues') {
		...
		$get_data=$obj_advancecommornon->get_edit_advance_details($id);
