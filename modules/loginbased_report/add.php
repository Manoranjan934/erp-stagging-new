                                    ...
                                    <fieldset>
                                       ...
                                       <?php 
                                               while ($getSINOvaldata = mysqli_fetch_array($getCreditPaymentList)) {
                                                    echo '<option data-cusID="'.$getSINOvaldata['fk_customer_id'] .'" data-totalAmt="'.$getSINOvaldata['grand_total'] .'" data-remainingAmt="'.$getSINOvaldata['remaining_amount'] .'" value="'.$getSINOvaldata['PK_SE_ID'] .'">'.$getSINOvaldata['eno'].'</option>';
                                               }
