$(document).ready(function() {
    ...
    var dataRecordsinprogress = $('#salesOrderTable').DataTable({
    ...
    /*
        $('.search_keyestcomins').on('click', function(e) {
            if ($('.searchKeywordestcomins').val() != '') {
                dataRecordsinprogress.search($('.searchKeywordestcomins').val()).draw();
            } else { dataRecordsinprogress.search('').columns().search('').draw(); }
        });*/

    var dataRecordscompleted = $('#salesOrdercompleteTable').DataTable({
        "footerCallback": function(row, data, start, end, display) {
            var roleId = $('#getSessRollId').val();
    ...
    var dataRecordscancelled = $('#salesOrdercancelledTable').DataTable({
        "footerCallback": function(row, data, start, end, display) {
            var roleId = $('#getSessRollId').val();
        ...
        "ajax": {
            url: "modules/sales/ajax_functions_commercial.php",
            type: "POST",
            data: { mode: 'listEstimateCommCancelled' },
            dataType: "json"
        },
        "columnDefs": [{
                //"targets": [0, 6, 7],
    ...
    /*    $('.search_keyestcomcomt').on('click', function(e) {
            if ($('.searchKeywordestcomcomt').val() != '') {
                dataRecordscompleted.search($('.searchKeywordestcomcomt').val()).draw();
            } else { dataRecordscompleted.search('').columns().search('').draw(); }
        });*/
    ...
    // });
    $("#salesOrderTable").on('click', '.btnCancelval', function() {
    ...
    $("#salesOrdercompleteTable").on('click', '.btnCancelval', function() {
        var id = $(this).attr("data-id");
        var sono = $(this).attr("data-sono");
        $('#txt_oid').val(id);
        $('#txt_ono').text(sono);
