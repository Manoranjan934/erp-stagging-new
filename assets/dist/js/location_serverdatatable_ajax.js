...
$(document).ready(function() {
    ...
    var dataRecords = $('#locationreportTable').DataTable({
        "lengthChange": true,
        "processing": true,
        "serverSide": true,
        'processing': true,
        ...
        "order": [],
        "ajax": {
            url: "modules/location_report/ajax_functions.php",
            type: "POST",
            //  data: { mode: 'filterlistSalesOrder' },
            data: function(d) {
                d.mode = 'filterlistSalesOrder';
                d.fromDate = $('#fromDate').val();
                d.toDate = $('#toDate').val();
                d.statusfilter = $('#status-filter').find(":selected").val();
