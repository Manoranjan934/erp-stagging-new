...
class Box {
	...
	function getallBox(){
		$query = "SELECT * FROM ".BOX." WHERE visibility = '1' ORDER BY pk_box_id DESC";
		$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
		return $result;
	}
	function AddBox(){
		$res = 0;
		$sql = "SELECT * FROM ".BOX." WHERE name ='".$this->name."' AND visibility = '1'";
		...
		if($counts > 0){
			...
			$query = "INSERT INTO ".BOX." SET name ='".$this->name."',cost ='".$this->cost."', visibility = '1', description='".TRIM($this->description)."'";
			$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			$res = 1;
		}	
		return $res;
	...
	function geteditBox(){
		$query = "SELECT * FROM ".BOX." WHERE  pk_box_id='".$this->id."' AND visibility = '1'";
		$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
		return $result;
	}
	function EditBox(){
		$res = 0;
		$sql2 = "SELECT * FROM ".BOX." WHERE name ='".$this->name."' AND pk_box_id != '".$this->id."' AND visibility='1'";
		...
		if($counts1 > 0){
		 ...
		 $query = "UPDATE ".BOX." SET name ='".$this->name."',cost ='".$this->cost."', visibility = '1', description='".TRIM($this->description)."' WHERE pk_box_id =".$this->id."";
	...
	function deleteBox(){
		$res = 0;
		$sql = "UPDATE ".BOX." SET visibility='0' WHERE pk_box_id=".$this->id."";
		$rest = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
		if($rest){
			$res = 1;
		}
