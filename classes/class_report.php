    ...
    */
    ...
    public function listCommCustomerReport()
    {
        ...
        while ($record = mysqli_fetch_assoc($stmt)) {
            ...
            <a href='index.php?erp=67&id={$record['PK_ES_ID']}' 
   ...
   View Bill
    ...
    public function listNonCommCustomerReport()
    {
        ...
        while ($record = mysqli_fetch_assoc($stmt)) {
            ...
            <a href='index.php?erp=69&id={$record['PK_ES_ID']}' 
   class='btn btn-sm btn-warning'>
   View Bill
</a>";
...
*/
            ...
            /*if ( $record[ 'status' ] == 2 && $record[ 'osstatus' ] == NULL )
 {
    ...
    public function listCommDeliveredReport()
    {
        ...
        $toDate = str_replace('/', '-', $_POST['toDate']);
        $toDateval = date('Y-m-d', strtotime($toDate));
        $franchise = isset($_POST['txt_franchise_name']) ? $_POST['txt_franchise_name'] : '';
        ...
        $franchiseCondTotal = '';
        if (!empty($franchise)) {
            $franchiseCondTotal = " AND franchise = '" . $franchise . "' ";
        }
        ...
        if (!empty($_POST['search']['value'])) {
            ...
            $sqlQuery .= ' where (est.visibility=1 ' . $cusid . $franchiseCondTotal . ' AND  DATE_FORMAT(est.delivery_date, "%Y-%m-%d") BETWEEN "' . $fromDateval . '" AND "' . $toDateval . '")';
        ...
        $stmtTotal = mysqli_query($GLOBALS['___mysqli_ston'], 'SELECT * FROM  erp_estimate_comm where visibility=1 ' . $cusidval . $franchiseCondTotal);
    ...
    public function listNonCommDeliveredReport()
    {
        ...
        $stmtTotal = mysqli_query($GLOBALS['___mysqli_ston'], 'SELECT * FROM  erp_estimate_noncomm where visibility=1 ' . $cusidval . $franchiseCondTotal);
    ...
    public function listCommBulkPaymentReport()
    {
        ...
        while ($record = mysqli_fetch_assoc($stmt)) {
            ...
            $rows[] = '
<a href="index.php?erp=130&id=' . $record['pk_adv_com_id'] . '&typ=1" 
class="custom_btn_class btn btn-view" title="View">
<span class="fa fa-eye"></span>
</a>

<button class="btn btn-primary btn-sm editBtn" 
data-id="' . $record['pk_adv_com_id'] . '" 
data-type="1" 
title="Edit">
...
';
    ...
    public function listNonCommBulkPaymentReport()
    {
        ...
        while ($record = mysqli_fetch_array($stmt)) {
            ...
            $rows[] = '
<a href="index.php?erp=130&id=' . $record['pk_adv_noncom_id'] . '&typ=2" 
class="custom_btn_class btn btn-view" title="View">
<span class="fa fa-eye"></span>
</a>

<button class="btn btn-primary btn-sm editBtn" 
data-id="' . $record['pk_adv_noncom_id'] . '" 
data-type="2" 
title="Edit">
<span class="fa fa-edit"></span>
</button>
