...
class Size {
	...
	function getallSize(){
		$query = "SELECT * FROM ".SIZE." WHERE visibility = '1' ORDER BY pk_size_id DESC";
		$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
		return $result;
	}
	function AddSize(){
		$res = 0;
		$sql = "SELECT * FROM ".SIZE." WHERE name ='".$this->name."' AND visibility = '1'";
		...
		if($counts > 0){
			...
			$query = "INSERT INTO ".SIZE." SET name ='".$this->name."',cost ='".$this->cost."', visibility = '1', description='".TRIM($this->description)."'";
			$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			$res = 1;
		}	
		return $res;
	...
	function geteditSize(){
		$query = "SELECT * FROM ".SIZE." WHERE  pk_size_id='".$this->id."' AND visibility = '1'";
		$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
		return $result;
	}
	function EditSize(){
		$res = 0;
		$sql2 = "SELECT * FROM ".SIZE." WHERE name ='".$this->name."' AND pk_size_id != '".$this->id."' AND visibility='1'";
		...
		$query = "UPDATE ".SIZE." SET name ='".$this->name."',cost ='".$this->cost."', visibility = '1', description='".TRIM($this->description)."' WHERE pk_size_id =".$this->id."";
	...
	function deleteSize(){
		$res = 0;
		$sql = "UPDATE ".SIZE." SET visibility='0' WHERE pk_size_id=".$this->id."";
		$rest = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
		if($rest){
			$res = 1;
		}
