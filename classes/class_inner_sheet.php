...
class Inner_sheet {
	...
	public function __construct($c_pk_id,$c_name,$c_cost,$c_description, $c_visibility,$c_created_on,$c_updated_on) {
	...
	function getallInnersheet(){
		$query = "SELECT * FROM ".INNER_SHEET." WHERE visibility = '1' ORDER BY pk_is_id DESC";
		$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
		return $result;
	}
	function AddInnersheet(){
		$res = 0;
		$sql = "SELECT * FROM ".INNER_SHEET." WHERE name ='".$this->name."' AND visibility = '1'";
		...
		if($counts > 0){
			...
			$query = "INSERT INTO ".INNER_SHEET." SET name ='".$this->name."',cost ='".$this->cost."', visibility = '1', description='".TRIM($this->description)."'";
	...
	function geteditInnersheet(){
		$query = "SELECT * FROM ".INNER_SHEET." WHERE  pk_is_id='".$this->id."' AND visibility = '1'";
		$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
		return $result;
	}
	function EditInnersheet(){
		$res = 0;
		$sql2 = "SELECT * FROM ".INNER_SHEET." WHERE name ='".$this->name."' AND pk_is_id != '".$this->id."' AND visibility='1'";
		...
		if($counts1 > 0){
			...
			$query = "UPDATE ".INNER_SHEET." SET name ='".$this->name."',cost ='".$this->cost."', visibility = '1', description='".$this->description."' WHERE pk_is_id =".$this->id."";
			$result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			$res = 1;
		}		
		return $res;
	...
	function deleteInnersheet(){
		...
		$res = 0;
		$sql = "UPDATE ".INNER_SHEET." SET visibility='0' WHERE pk_is_id=".$this->id."";
		$rest = mysqli_query($GLOBALS["___mysqli_ston"], $sql);
		if($rest){
			$res = 1;
		}
