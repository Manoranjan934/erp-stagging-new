<?php
	class CommercialProduct {
		...
		function getAllProducts(){
			...
			$query = "SELECT * FROM ".COMMERCIAL_PRODUCTS." AS p LEFT JOIN ".CATEGORY." AS c ON c.pk_cat_id = p.fk_catgeory_id WHERE p.visibility='1' GROUP BY p.product_name ORDER BY p.product_name ASC";

			$res = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			return $res;
		}
		function delete_product(){
			$query = "UPDATE ".COMMERCIAL_PRODUCTS." SET visibility='0' WHERE pk_commprod_id='".$this->pk_product_id."'";
			$res = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			return 1;
		}
		function productAdd(){
		 //	$query = "INSERT INTO ".PRODUCT." SET product_name='".$this->product_name."', product_hsn='".$this->product_hsn."', inner_sheet='".$this->inner_sheet."', special_effect='".$this->special_effect."', size='".$this->size."', product_cgst='".$this->product_cgst."', product_sgst='".$this->product_sgst."', product_igst='".$this->product_igst."', product_price='".$this->product_price."', product_desc='".$this->product_desc."', product_uom ='".$uom."', fk_catgeory_id='".$this->fk_catgeory_id."', fk_uom_id='".$this->fk_uom_id."'";
		 	$query = "INSERT INTO ".COMMERCIAL_PRODUCTS." SET product_name='".$this->product_name."', comm_prod_code ='".$this->prodcode."',additionalcopy_price='".$this->additional_price."', firstcopy_price='".$this->first_price."', product_desc='".$this->product_desc."' , visibility=1";
	
			$res = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			return 1;
		}
		function Editproduct(){
			$query = "SELECT * FROM ".COMMERCIAL_PRODUCTS." WHERE pk_commprod_id = '".$this->pk_product_id."'";
			$res = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			return $res;
		}
		function productEdit(){
			//$query = "UPDATE ".PRODUCT." SET product_name='".$this->product_name."', product_hsn='".$this->product_hsn."',inner_sheet='".$this->inner_sheet."', special_effect='".$this->special_effect."', size='".$this->size."', product_cgst='".$this->product_cgst."', product_sgst='".$this->product_sgst."', product_igst='".$this->product_igst."', product_price='".$this->product_price."', product_desc='".$this->product_desc."', fk_catgeory_id='".$this->fk_catgeory_id."', fk_uom_id='".$this->fk_uom_id."' WHERE pk_product_id = '".$this->pk_product_id."'";
			 $query = "UPDATE ".COMMERCIAL_PRODUCTS." SET product_name='".$this->product_name."', additionalcopy_price='".$this->additional_price."', firstcopy_price='".$this->first_price."', product_desc='".$this->product_desc."' WHERE pk_commprod_id = ".$this->pk_product_id."";
			$res = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			return 1;
		}
		function getproduct_byid(){
			$query = "SELECT p.additionalcopy_price,p.firstcopy_price,p.product_name FROM ".COMMERCIAL_PRODUCTS." AS p  WHERE p.pk_commprod_id = '".$this->pk_product_id."'";
			//echo $query;
			$res = mysqli_query($GLOBALS["___mysqli_ston"], $query);
			return $res;
		}
		...
		function getLastproductID(){
			$query = "SELECT  cp_no FROM ".COMMERCIAL_PRODUCTS." ORDER BY cp_no DESC ";
			$res = mysqli_query($GLOBALS["___mysqli_ston"], $query);
